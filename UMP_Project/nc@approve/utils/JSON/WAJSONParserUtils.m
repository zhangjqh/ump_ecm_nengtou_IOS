 ...
 */
@implementation CWAJSONParserUtils
...
{
    return [aString objectFromJSONStringWithParseOptions:JKSerializeOptionNone error:theError];  
}
...
+(NSString*)jsonStyleStringFromValues:(id)aValues 
                                error:(NSError**)theError
{
   return [aValues JSONStringWithOptions:JKSerializeOptionNone error:theError];
}
...
{
    return [aJson valueForKeyPath:akeyPath];
}
@end
