...
@interface CWAStyle1NC63ViewController ()

@end

@implementation CWAStyle1NC63ViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
  ...
  if (section == 0 )
  {
    if(iFeedVieVO.iReminderContent &&  (iFeedVieVO.iTaskAcListHint && ![@"" isEqualToString:iFeedVieVO.iTaskAcListHint]))
    {
      headerHeight = 48;
    }
