...
@interface MaHomeView : NSObject<UIGestureRecognizerDelegate>{
...
/// view高亮显示的时间（之后透明度变为viewTransparency）
@property (nonatomic,assign) CGFloat highlightedTime ;

/// view 高亮之后的透明度。(默认为0)
@property (nonatomic,assign) CGFloat viewTransparency ;
...
@property (nonatomic,assign)MaHomeView *selfBoard;
