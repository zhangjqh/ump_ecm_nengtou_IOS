...
@protocol CWAProgressViewDelegate;


typedef enum {
	/** Progress is shown using an UIActivityIndicatorView. This is the default. */
	MBProgressViewModeIndeterminate,
	/** Progress is shown using a round, pie-chart like, progress view. */
	MBProgressViewModeDeterminate,
	/** Progress is shown using a ring-shaped progress view. */
	MBProgressViewModeAnnularDeterminate,
	/** Shows a custom view */
	MBProgressViewModeCustomView,
	/** Shows only labels */
	MBProgressViewModeText
} MBProgressViewMode;

typedef enum {
	/** Opacity animation */
	MBProgressViewAnimationFade,
	/** Opacity + scale animation */
	MBProgressViewAnimationZoom
} MBProgressViewAnimation;
 ...
 */
@interface CWAProgressView : UIView
 ...
 */
@property (assign) MBProgressViewMode mode;
 ...
 */
@property (assign) MBProgressViewAnimation animationType;
 ...
 *
 * @see CWAProgressHUDDelegate
 */
@property (MB_WEAK) id<CWAProgressViewDelegate> delegate;
...
@protocol CWAProgressViewDelegate <NSObject>
 ...
 */
- (void)viewWasHidden:(CWAProgressView *)view;
/**
 * Hide the HUD. This still calls the hudWasHidden: delegate. This is the counterpart of the show: method. Use it to
 */
- (void)hudWasHidden:(CWAProgressView*)aProgressView;
