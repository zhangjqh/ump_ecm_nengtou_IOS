...
@interface ecm_mobilestoreController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Ecm_Mobilestore;
- (UMLayoutView*)Ecm_Mobilestore BV_OBJC_METHOD_FAMILY_NONE;
