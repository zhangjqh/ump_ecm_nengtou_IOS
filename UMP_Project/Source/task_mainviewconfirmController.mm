...
@interface task_mainviewconfirmController ()
{
...
@implementation task_mainviewconfirmController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize mainviewconfirm = _mainviewconfirm;
...
static NSString *controllerC = @"mainviewconfirmController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_mainviewconfirm addSubUMView:_viewPage0];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"querytasklist" method:@"UMView.open" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"tasklistonload" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"{tasktype:'6'}" forKey:@"params"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"getfirstpage" method:@"UMList.getFirstPage" sender:sender]];
 ...
 [args putValue:@"6" forKey:@"tasktype"];
...
[args setInvoke:[self getInvokeInfo:@"confirm" method:@"confirm" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
