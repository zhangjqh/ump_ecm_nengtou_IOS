...
@interface task_reportconfirmdetailController ()
{
...
@implementation task_reportconfirmdetailController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize reportconfirmdetail = _reportconfirmdetail;
...
@synthesize Scrollview_panel0 = _Scrollview_panel0;
...
static NSString *controllerC = @"reportconfirmdetailController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"reportconfirmdetail";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _reportconfirmdetail = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_reportconfirmdetail addSubUMView:_viewPage0];
     //设置控件基本属性
...
[UIApplication sharedApplication].keyWindow.backgroundColor = [_navigatorbar0 backgroundColor];
    ...
    _panel123 = [[UMLayoutView alloc] init];
    _panel123.controlId = @"panel123";
    _panel123.layoutType = Layout_vbox;
    [(UMLayoutView*)_viewPage0 addSubUMView:_panel123];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_panel123 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"1",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.task_tobeconfirmedreport}"}];
...
_Scrollview_panel0 = [[UMScrollView alloc] init];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_Scrollview_panel0 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
    ...
    _Scrollview_panel0.weightUMPView = 1;

    _Scrollview_panel0.layoutType = Layout_vbox;

    _Scrollview_panel0.hScrollType=UMScrollDirectionAuto;
    _Scrollview_panel0.vScrollType=UMScrollDirectionAuto;
    [(UMLayoutView*)_panel123 addSubUMView:_Scrollview_panel0];

    _panel0 = [[UMLayoutView alloc] init];
    _panel0.controlId = @"panel0";
    _panel0.layoutType = Layout_vbox;
    [(UMLayoutView*)_Scrollview_panel0 addSubUMView:_panel0];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel0 addSubUMView:_rounddiv0];
     //设置控件基本属性
    ...
    [_rounddiv0 setContainer:self];
    [_rounddiv0 addEvent:@"onclick" actionName:@"getreporthistory"];

    _rounddiv1 = [[UMLayoutView alloc] init];
    _rounddiv1.controlId = @"rounddiv1";
    _rounddiv1.layoutType = Layout_vbox;
    [(UMLayoutView*)_panel1 addSubUMView:_rounddiv1];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_rounddiv1 addSubUMView:_rounddiv5];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_rounddiv1 addSubUMView:_rounddiv6];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_rounddiv1 addSubUMView:_rounddiv7];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_rounddiv1 addSubUMView:_rounddiv9];
     //设置控件基本属性
    ...
    [_rounddiv9 addEvent:@"onclick" actionName:@"openattwin"];
...
// --label1
    _label1 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv3 addSubUMXView:_label1];
...
// --label2
    _label2 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.task_newreport}"}];
    [(UMLayoutView*)_rounddiv4 addSubUMXView:_label2];
...
// --label3
    _label3 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv4 addSubUMXView:_label3];
...
// --label6
    _label6 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv4 addSubUMXView:_label6];
...
// --label7
    ...
    [(UMLayoutView*)_rounddiv5 addSubUMXView:_label7];
...
// --label8
    _label8 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv5 addSubUMXView:_label8];
...
// --progressbar0
    ...
    [(UMLayoutView*)_rounddiv6 addSubUMXView:_progressbar0];
...
// --label10
    _label10 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.task_completionSate}"}];
    [(UMLayoutView*)_rounddiv7 addSubUMXView:_label10];
...
// --label11
    _label11 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv7 addSubUMXView:_label11];
...
// --label16
    _label16 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv9 addSubUMXView:_label16];

// --button13
    _button13 = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          @"halign":@"center",
...
// --label12
    _label12 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv10 addSubUMXView:_label12];
...
// --label14
    _label14 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv10 addSubUMXView:_label14];
...
// --button4
    _button4 = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          ...
                          @"valign":@"center",
                          @"background-image":@"ecm_arrow_right.png",@"value":@""}];
    [(UMLayoutView*)_rounddiv10 addSubUMXView:_button4];
...
// --button0
    _button0 = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          ...
                          @"color":@"#e50011",
                          @"font-size":@"18",
                          @"value":@"#{res.task_reject}",
                          @"onclick":@"refuseclick",
                          @"font-family":@"default",
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",
                          @"background-image":@"button"}];
    [(UMLayoutView*)_toolbar0 addSubUMXView:_button0];
...
// --label13
    _label13 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_toolbar0 addSubUMXView:_label13];
...
[self reportonload:nil  args:nil];
...
[self umcontrol:_label1 controlid:@"label1" bindfield:@"reportheme"];


[self umcontrol:_label3 controlid:@"label3" bindfield:@"reporttime"];

[self umcontrol:_label6 controlid:@"label6" bindfield:@"reportname"];


[self umcontrol:_label8 controlid:@"label8" bindfield:@"taskstate"];

[self umcontrol:_progressbar0 controlid:@"progressbar0" bindfield:@"taskschedule"];


[self umcontrol:_label11 controlid:@"label11" bindfield:@"completionnew"];


[self umcontrol:_label16 controlid:@"label16" bindfield:@"count"];



[self umcontrol:_label12 controlid:@"label12" bindfield:@"taskid"];
...
- (void)agreeclick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"agreeclick" method:@"agreeclick" sender:sender]];

 [args putValue:@"true" forKey:@"isDataCollect"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)refuseclick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"refuseclick" method:@"refuseclick" sender:sender]];
...
- (void)openattwin:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"openattwin" method:@"openattwin" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"getreporthistory" method:@"getreporthistory" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)reportonload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"reportonload" method:@"reportonload" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
