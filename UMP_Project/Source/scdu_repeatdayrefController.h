...
@interface scdu_repeatdayrefController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	repeatdayref;
- (UMLayoutView*)repeatdayref BV_OBJC_METHOD_FAMILY_NONE;
