...
@interface addr_psnupdategroupController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	psnUpdateGroup;
- (UMLayoutView*)psnUpdateGroup BV_OBJC_METHOD_FAMILY_NONE;
