...
#import "flow_handwriteController.h"
...
@interface flow_handwriteController ()
{
...
@implementation flow_handwriteController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize HandWrite = _HandWrite;
...
static NSString *controllerC = @"HandWriteController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"HandWrite";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_HandWrite addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_handwrite}"}];
    [(UMLayoutView*)_centerPanel addSubUMXView:_navLabel];

// --handImg
    _handImg = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"handImg",
                          @"bindfield":@"content",
                          @"height":@"fill",
                          @"width":@"fill",
                          @"scaletype":@"fitcenter",
                          @"src":@"",@"value":@""}];
    [(UMLayoutView*)_mainPanel addSubUMXView:_handImg];
...
[self umcontrol:_handImg controlid:@"handImg" bindfield:@"content"];
...
[args setInvoke:[self getInvokeInfo:@"onDataLoad" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"#{plug.handwrite}" forKey:@"handwrite"];

 [args putValue:@"nc.bs.oa.oama.freeflow.WorkController" forKey:@"viewid"];

 [args putValue:@"handwrite" forKey:@"action"];
