...
#import "scdu_shareschedulerController.h"
...
@interface scdu_shareschedulerController ()
{
...
@implementation scdu_shareschedulerController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize sharescheduler = _sharescheduler;
...
@synthesize calendar0 = _calendar0;
...
static NSString *controllerC = @"shareschedulerController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"calendar";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_sharescheduler addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --button0
    _button0 = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          ...
                          @"color":@"#e50011",
                          @"font-size":@"17",
                          @"value":@"#{res.scdu_oascheduler_0028}",
                          @"onclick":@"toToday",
                          @"font-family":@"default",
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",
    ...
    _calendar0 = [[UMCalendarView alloc] init];
_calendar0.bindfield = @"calendar";
     //设置控件基本属性
    [UMCompatible initCommonProperty:_calendar0 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
                          ...
                          @"",@"color",
                          [UIColor clearColor],@"backgroundColor",
                          @"calendar.png",@"backgroundImagePath",
                          [UIColor clearColor],@"background_color_dis",
                          @"",@"border-top-style",
                          @"",@"border-top-width",
                          @"",@"border-top-color",
    ...
    _calendar0.eventdaymodel = @"icon";
    _calendar0.cal_selectedDate_background_image = @"yellowcircle";
    _calendar0.cal_eventDay_iconPath = @"lightspot";
    _calendar0.cal_expiredEventDay_IconPath = @"graylightpot";
    [(UMLayoutView*)_panel0 addSubUMView:_calendar0];
[_calendar0 addDayChangedTarget:self action:@selector(daychange: args:)];
[_calendar0 addMonthChangedTarget:self action:@selector(monthchange: args:)];

    _panel1 = [[UMLayoutView alloc] init];
    _panel1.controlId = @"panel1";
    _panel1.layoutType = Layout_vbox;
[_calendar0 addSubUMView:_panel1];
     //设置控件基本属性
...
// --widget0_imagebutton0
    _widget0_imagebutton0 = [UMControl creatControl:@"UMXImageButton" container:self  params:@{
                          ...
                          @"font_family":@"ArialMT",
                          @"font-size":@"10",
                          @"value":@"#{res.scdu_oascheduler_0030}",
...
// --widget0_imagebutton1
    _widget0_imagebutton1 = [UMControl creatControl:@"UMXImageButton" container:self  params:@{
                          ...
                          @"font_family":@"ArialMT",
                          @"font-size":@"10",
                          @"value":@"#{res.scdu_oascheduler_0039}",
...
[self umcontrol:_label0 controlid:@"label0" bindfield:@"calendar.month"];

NSMutableArray* bindfieldscalendar0 = [[NSMutableArray alloc] init];
//NSString* value_calendar00 = [_ctx getValue:@"calendar"];
 //if(value_calendar00 == nil){value_calendar00 = @"";}
NSDictionary* dictionary_calendar00 = [NSDictionary dictionaryWithObject:_ctx forKey:@"calendar"];
[bindfieldscalendar0 addObject:dictionary_calendar00];
UMBindInfo* bindInfocalendar0 = [[UMBindInfo alloc]init];
		bindInfocalendar0.dataSourceName = @"dataNameTest";
    bindInfocalendar0.dataSourceType = @"Model";
    bindInfocalendar0.bindingType = UM_DATABINDING_TYPE_ONEWAYDATABIND;
     NSDictionary* paircalendar0 = [[NSDictionary alloc]initWithObjectsAndKeys:bindfieldscalendar0,@"_calendar0", nil];
 	    bindInfocalendar0.controlFieldPair = [[NSMutableDictionary alloc]initWithDictionary:paircalendar0];
    	    [_calendar0 setBindInfo:bindInfocalendar0];

         [_calendar0 dataBind];

[self umcontrol:_calendar0 controlid:@"calendar0" bindfield:@"calendar"];


[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"calendar.eventlist"];
...
- (void)monthchange:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"monthchange" method:@"UMCalendar.getMonthChange" sender:sender]];

 [args putValue:@"nc.bs.oa.oama.scheduler.CalendarExtendController" forKey:@"viewid"];

 [args putValue:@"getMonthScheduleinfo" forKey:@"action"];

 [args putValue:@"2" forKey:@"type"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)toShareScheduler:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toShareScheduler" method:@"toShareScheduler" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)toMyScheduler:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toMyScheduler" method:@"UMView.open" sender:sender]];

 [args putValue:@"scdu_myscheduler" forKey:@"viewid"];
...
- (void)toTimeset:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toTimeset" method:@"UMView.open" sender:sender]];

 [args putValue:@"scdu_timeset" forKey:@"viewid"];

 [args putValue:@"false" forKey:@"iskeep"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)toToday:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toToday" method:@"UMCalendar.getToToday" sender:sender]];

 [args putValue:@"calendar0" forKey:@"controlid"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)toSchedulerDetailOnce:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toSchedulerDetailOnce" method:@"toSchedulerDetailOnce" sender:sender]];

 [args putValue:@"cursorcalendar_eventlistalias" forKey:@"cursor"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"#{#{cursor.cursorcalendar_eventlistalias}}" forKey:@"row"];

 [args putValue:@"eventlist" forKey:@"row_arrayPath"];
  [UMCompatible exec:sender container:self cursor:@"cursorcalendar_eventlistalias"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)daychange:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"daychange" method:@"UMCalendar.getDayChange" sender:sender]];

 [args putValue:@"nc.bs.oa.oama.scheduler.CalendarExtendController" forKey:@"viewid"];

 [args putValue:@"getEventList" forKey:@"action"];
...
- (void)toSchedulerDetail:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toSchedulerDetail" method:@"toSchedulerDetail" sender:sender]];
...
- (void)toSchedulerDetailAll:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toSchedulerDetailAll" method:@"toSchedulerDetailAll" sender:sender]];
