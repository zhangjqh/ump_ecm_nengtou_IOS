...
@interface addr_psngroupController_listview0_tableViewCell:LHTableViewCell
...
@interface addr_psngroupController_listview0_group : LHGroup
...
@interface addr_psngroupController_listview0_cellHeight : NSObject
@property (strong) UMLayoutView* listview0_childWgt0;
- (UMLayoutView*)listview0_childWgt0 BV_OBJC_METHOD_FAMILY_NONE;
