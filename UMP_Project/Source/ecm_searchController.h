...
@interface ecm_searchController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Search;
- (UMLayoutView*)Search BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* searchInput;
