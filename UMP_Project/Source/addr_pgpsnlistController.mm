...
#import "addr_pgpsnlistController.h"
...
@interface addr_pgpsnlistController ()
{
...
@implementation addr_pgpsnlistController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize pgPsnList = _pgPsnList;
...
static NSString *controllerC = @"pgPsnListController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_pgPsnList addSubUMView:_viewPage0];
     //设置控件基本属性
...
- (void)delPsn:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"delPsn" method:@"delPsn" sender:sender]];

 [args putValue:@"persons" forKey:@"psnrow_arrayPath"];

 [args putValue:@"cursorpersonsalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorpersonsalias}}" forKey:@"psnrow"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"#{plug.row}" forKey:@"pgrow"];
...
- (void)toPgAddPsn:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toPgAddPsn" method:@"toPgAddPsn" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)toDelPsn:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toDelPsn" method:@"toDelPsn" sender:sender]];
...
- (void)onloadCallback:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onloadCallback" method:@"onloadCallback" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"listViewOnload" method:@"listViewOnload" sender:sender]];
 ...
 [args putValue:@"#{plug.row}" forKey:@"currentrow"];
...
[args setInvoke:[self getInvokeInfo:@"onBack" method:@"UMView.open" sender:sender]];
