...
@interface flow_attachmentlistController_listView_tableViewCell:LHTableViewCell
...
@property (nonatomic,strong) UMView* sizeTxt;
...
@interface flow_attachmentlistController_listView_group : LHGroup
...
@interface flow_attachmentlistController_listView_cellHeight : NSObject
@property (strong) UMLayoutView* itemPanel;
- (UMLayoutView*)itemPanel BV_OBJC_METHOD_FAMILY_NONE;
