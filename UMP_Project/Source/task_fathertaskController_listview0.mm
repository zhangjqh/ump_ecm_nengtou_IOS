#import "task_fathertaskController_listview0.h"
@interface task_fathertaskController_listview0_tableViewCell ()
{
	
}
@end
@implementation task_fathertaskController_listview0_tableViewCell
...
-(void)bindAll:(UMEntityContext *)_ctx{
	...
	[self umcontrol:_listview0_childWgt0_label1 controlid:@"listview0_childWgt0_label1" bindfield:@"taskid"];
[self umcontrol:_listview0_childWgt0_label0 controlid:@"listview0_childWgt0_label0" bindfield:@"taskname"];
...
@interface task_fathertaskController_listview0_group ()
{
	
}
@end
@implementation task_fathertaskController_listview0_group
...
@interface task_fathertaskController_listview0_cellHeight ()
{
	
}
@end
@implementation task_fathertaskController_listview0_cellHeight
