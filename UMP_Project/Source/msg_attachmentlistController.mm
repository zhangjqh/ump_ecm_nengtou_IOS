...
#import "msg_attachmentlistController.h"
...
@interface msg_attachmentlistController ()
{
...
@implementation msg_attachmentlistController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize Msg_AttachmentList = _Msg_AttachmentList;
...
static NSString *controllerC = @"Msg_AttachmentListController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _Msg_AttachmentList = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Msg_AttachmentList addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.msg_AttachList}"}];
...
[self umcontrol:_listView controlid:@"listView" bindfield:@"attachmentlist"];
...
[args setInvoke:[self getInvokeInfo:@"onDeleteBtnClick" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"attachmentlist" forKey:@"attachname_arrayPath"];

 [args putValue:@"#{cursor.cursorattachmentlistalias.index}" forKey:@"index"];

 [args putValue:@"cursorattachmentlistalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.id}" forKey:@"attachid"];

 [args putValue:@"nc.bs.oa.oama.ecm.MaFileController" forKey:@"viewid"];

 [args putValue:@"attachmentlist" forKey:@"index_arrayPath"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.name}" forKey:@"attachname"];

 [args putValue:@"attachmentlist" forKey:@"attachid_arrayPath"];

 [args putValue:@"delete" forKey:@"action"];

 [args putValue:@"deleteCallback" forKey:@"callback"];

 [args putValue:@"false" forKey:@"autodatabinding"];

 [args putValue:@"ResultValue" forKey:@"contextmapping"];
  [UMCompatible exec:sender container:self cursor:@"cursorattachmentlistalias"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)OnLoadData:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"OnLoadData" method:@"OnLoadData" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"onItemClick" method:@"onItemClick" sender:sender]];
 ...
 [args putValue:@"oaco" forKey:@"modulename"];

 [args putValue:@"cursorattachmentlistalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}}" forKey:@"row"];

 [args putValue:@"attachmentlist" forKey:@"row_arrayPath"];
  [UMCompatible exec:sender container:self cursor:@"cursorattachmentlistalias"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)deleteCallback:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"deleteCallback" method:@"deleteCallback" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"onAddBtnClick" method:@"UMService.uploadImage" sender:sender]];
 ...
 [args putValue:@"UploadFile" forKey:@"contextmapping"];
[UMCommonSevice callSeviceWithMethod:args];
