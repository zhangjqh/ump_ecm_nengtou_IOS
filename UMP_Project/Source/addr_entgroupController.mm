...
@interface addr_entgroupController ()
{
...
static NSString *controllerC = @"entGroupController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"eGroupList";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_entGroup addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.addr_oaadl_0003}"}];
...
[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"eGroups"];
...
[args setInvoke:[self getInvokeInfo:@"toPsnList" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"cursoreGroupsalias" forKey:@"cursor"];

 [args putValue:@"addr_psnlist" forKey:@"viewid"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"listViewOnload" forKey:@"callback"];

 [args putValue:@"true" forKey:@"iskeep"];

 [args putValue:@"ent" forKey:@"type"];

 [args putValue:@"#{#{cursor.cursoreGroupsalias}}" forKey:@"row"];

 [args putValue:@"eGroups" forKey:@"row_arrayPath"];
  [UMCompatible exec:sender container:self cursor:@"cursoreGroupsalias"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"toEntGroup" method:@"toEntGroup" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)refresh:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"refresh" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"nc.bs.oa.oama.addresslist.EGroupListExtendController" forKey:@"viewid"];

 [args putValue:@"getEnterpriseGroup" forKey:@"action"];

 [args putValue:@"setSelector" forKey:@"callback"];

 [args putValue:@"true" forKey:@"autoDataBinding"];

 [args putValue:@"true" forKey:@"isupdate"];
[UMCommonSevice callSeviceWithMethod:args];
