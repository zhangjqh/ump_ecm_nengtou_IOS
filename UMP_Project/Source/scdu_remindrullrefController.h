...
@interface scdu_remindrullrefController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	remindrullref;
- (UMLayoutView*)remindrullref BV_OBJC_METHOD_FAMILY_NONE;
