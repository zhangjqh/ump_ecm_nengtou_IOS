...
@interface flow_defaultcontentController ()
{
...
@implementation flow_defaultcontentController
...
static NSString *controllerC = @"DefaultContentController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_DefaultContent addSubUMView:_basePanel];
     //设置控件基本属性
