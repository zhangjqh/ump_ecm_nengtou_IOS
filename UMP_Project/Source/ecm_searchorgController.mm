...
#import "ecm_searchorgController.h"
...
@interface ecm_searchorgController ()
{
...
@synthesize typePanel = _typePanel;

@synthesize borderPanel = _borderPanel;
...
static NSString *controllerC = @"EcmSearchOrgController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"Search";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_SearchOrg addSubUMView:_basePanel];
     //设置控件基本属性
    ...
    _typePanel = [[UMLayoutView alloc] init];
    _typePanel.controlId = @"typePanel";
    _typePanel.layoutType = Layout_hbox;
    [(UMLayoutView*)_basePanel addSubUMView:_typePanel];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_typePanel info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"15",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"15",@"paddingRightUMP",
    ...
    _borderPanel = [[UMLayoutView alloc] init];
    _borderPanel.controlId = @"borderPanel";
    _borderPanel.layoutType = Layout_hbox;
    [(UMLayoutView*)_basePanel addSubUMView:_borderPanel];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_borderPanel info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
    ...
    _mainPanel.layoutType = Layout_hbox;
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.ecm_searchperson}"}];
    [(UMLayoutView*)_centerPanel addSubUMXView:_navLabel];

// --searchBtn
    _searchBtn = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          @"halign":@"center",
                          @"p_txt_r":@"0.9490196",
                          @"width":@"55",
                          @"font_size":@"17",
                          ...
                          @"color":@"#e50011",
                          @"font-size":@"17",
                          @"value":@"#{res.ecm_search}",
                          @"onclick":@"onSeartchBtnClick",
                          @"font-family":@"default",
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",
                          @"p_txt_g":@"0.6784314"}];
    [(UMLayoutView*)_rightPanel addSubUMXView:_searchBtn];

// --numLabel
    _numLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"right",
                          @"weight":@"1",
                          @"width":@"0",
                          @"font_size":@"17",
                          ...
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rightPanel addSubUMXView:_numLabel];

// --toggleGroup
    _toggleGroup = [UMControl creatControl:@"UMXToggleButtonGroup" container:self  params:@{
                          @"id":@"toggleGroup",
                          @"weight":@"1",
                          @"height":@"30",
                          @"width":@"0",
                          ...
                          @"value":@"buttongroup",
                          @"valign":@"center"}];
    [(UMLayoutView*)_typePanel addSubUMXView:_toggleGroup];

// --orgBtn
    _orgBtn = [UMControl creatControl:@"UMXToggleButton" container:self  params:@{
                          @"p_txt_r":@"1.0",
                          @"background-image-off":@"tab_left.png",
                          @"font_size":@"12",
                          @"textoff":@"#{res.flow_orgnav}",
                          ...
                          @"onclick":@"loadData",
                          @"font-family":@"default",
                          @"texton":@"#{res.flow_orgnav}",
                          @"valign":@"center",
                          @"checked":@"true"}];
    [(UMLayoutView*)_toggleGroup addView:_orgBtn];

// --entBtn
    _entBtn = [UMControl creatControl:@"UMXToggleButton" container:self  params:@{
                          @"p_txt_r":@"1.0",
                          @"halign":@"center",
                          ...
                          @"font-family":@"default",
                          @"texton":@"#{res.flow_entgroup}",
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",
                          @"p_txt_g":@"1.0"}];
    [(UMLayoutView*)_toggleGroup addView:_entBtn];

// --groupBtn
    _groupBtn = [UMControl creatControl:@"UMXToggleButton" container:self  params:@{
                          @"p_txt_r":@"1.0",
                          @"halign":@"center",
                          @"background-image-off":@"tab_mid.png",
                          @"width":@"72",
                          ...
                          @"font-family":@"default",
                          @"texton":@"#{res.flow_mygroup}",
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",
                          @"p_txt_g":@"1.0"}];
    [(UMLayoutView*)_toggleGroup addView:_groupBtn];

// --listBtn
    _listBtn = [UMControl creatControl:@"UMXToggleButton" container:self  params:@{
                          @"p_txt_r":@"1.0",
                          @"halign":@"center",
                          ...
                          @"font-family":@"default",
                          @"texton":@"#{res.flow_mydept}",
                          @"txt_b":@"0.06666667",
                          @"valign":@"center",
                          @"p_txt_g":@"1.0"}];
    [(UMLayoutView*)_toggleGroup addView:_listBtn];
...
[self umcontrol:_listView controlid:@"listView" bindfield:@"list"];
...
[args setInvoke:[self getInvokeInfo:@"onItemClick" method:@"onItemClick" sender:sender]];

 [args putValue:@"cursorlistalias" forKey:@"cursor"];

 [args putValue:@"list" forKey:@"rowindex_arrayPath"];

 [args putValue:@"#{cursor.cursorlistalias.index}" forKey:@"rowindex"];
  [UMCompatible exec:sender container:self cursor:@"cursorlistalias"];
...
- (void)onSelectedClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onSelectedClick" method:@"UMView.open" sender:sender]];

 [args putValue:@"ecm_searchselected" forKey:@"viewid"];

 [args putValue:@"selectedCallback" forKey:@"callback"];

 [args putValue:@"true" forKey:@"iskeep"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)onSeartchBtnClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onSeartchBtnClick" method:@"UMView.open" sender:sender]];

 [args putValue:@"ecm_search" forKey:@"viewid"];
...
- (void)onDeptBtnClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onDeptBtnClick" method:@"UMView.open" sender:sender]];
...
- (void)nextData:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"nextData" method:@"UMList.getNextPage" sender:sender]];

 [args putValue:@"nc.bs.oa.oama.ecm.PersonController" forKey:@"viewid"];

 [args putValue:@"nextDataError" forKey:@"error"];

 [args putValue:@"orgList" forKey:@"action"];

 [args putValue:@"listView" forKey:@"listid"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)loadError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"loadError" method:@"loadError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)onEGBtnClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onEGBtnClick" method:@"UMView.open" sender:sender]];

 [args putValue:@"ecm_searcheg" forKey:@"viewid"];

 [args putValue:@"false" forKey:@"iskeep"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)nextDataError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"nextDataError" method:@"nextDataError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)beforeLoad:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"beforeLoad" method:@"beforeLoad" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)loadDataFive:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"loadDataFive" method:@"UMList.getFirstPage" sender:sender]];

 [args putValue:@"25" forKey:@"count"];

 [args putValue:@"nc.bs.oa.oama.freeflow.PersonController" forKey:@"viewid"];
...
- (void)nextDataFive:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"nextDataFive" method:@"UMList.getNextPage" sender:sender]];
...
- (void)onPGBtnClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onPGBtnClick" method:@"UMView.open" sender:sender]];

 [args putValue:@"ecm_searchpg" forKey:@"viewid"];

 [args putValue:@"false" forKey:@"iskeep"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)loadData:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"loadData" method:@"UMList.getFirstPage" sender:sender]];

 [args putValue:@"25" forKey:@"count"];

 [args putValue:@"nc.bs.oa.oama.ecm.PersonController" forKey:@"viewid"];

 [args putValue:@"loadError" forKey:@"error"];
