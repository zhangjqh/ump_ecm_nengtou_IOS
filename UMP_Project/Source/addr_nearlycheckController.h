...
@interface addr_nearlycheckController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	nearlyCheck;
- (UMLayoutView*)nearlyCheck BV_OBJC_METHOD_FAMILY_NONE;
