...
@interface scdu_repeatdayrefController ()
{
...
@implementation scdu_repeatdayrefController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize repeatdayref = _repeatdayref;
...
static NSString *controllerC = @"repeatdayrefController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_repeatdayref addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --listview0
    _listview0 = [UMControl creatControl:@"UMXTableView" container:self  params:@{
                          ...
                          @"width":@"fill",
                          @"background-image":@"listview.png",@"value":@"             \n        "}];
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"Serif",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.scdu_oascheduler_0034}"}];
...
[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"repeatdayresfs"];
...
- (void)initChecked:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"initChecked" method:@"initChecked" sender:sender]];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"#{plug.crows}" forKey:@"crows"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"load" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"nc.bs.oa.oama.scheduler.RepeatRull1ExtendController" forKey:@"viewid"];

 [args putValue:@"initChecked" forKey:@"callback"];

 [args putValue:@"getRepeatdayList" forKey:@"action"];
...
[args setInvoke:[self getInvokeInfo:@"setChecked" method:@"setChecked" sender:sender]];
 ...
 [args putValue:@"repeatdayresfs" forKey:@"crow_arrayPath"];

 [args putValue:@"cursoronClickListRowalias" forKey:@"cursor"];

 [args putValue:@"repeatdayresfs" forKey:@"cindex_arrayPath"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"#{#{cursor.cursoronClickListRowalias}}" forKey:@"crow"];

 [args putValue:@"#{cursor.cursoronClickListRowalias.index}" forKey:@"cindex"];
