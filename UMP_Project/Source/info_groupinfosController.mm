...
#import "info_groupinfosController.h"
...
@interface info_groupinfosController ()
{
...
@implementation info_groupinfosController
...
static NSString *controllerC = @"groupinfosController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"oainfototal";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_groupinfos addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label5
    _label5 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.info_title_more}"}];
    [(UMLayoutView*)_navigatorbar0 addSubUMXView:_label5];

    _panel22 = [[UMLayoutView alloc] init];
    _panel22.controlId = @"panel22";
    _panel22.layoutType = Layout_vbox;
    [(UMLayoutView*)_navigatorbar0 addSubUMView:_panel22];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_panel22 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
...
// --listviewdefine0
    _listviewdefine0 = [UMControl creatControl:@"UMXTableView" container:self  params:@{
                          ...
                          @"width":@"fill",
                          @"layout":@"Layout_vbox",
                          @"groupindicator":@"infogrouptitle",@"value":@"                \n                \n                 \n            "}];
    [(UMLayoutView*)_panel0 addSubUMXView:_listviewdefine0];
...
[self umcontrol:_listviewdefine0 controlid:@"listviewdefine0" bindfield:@"initinfogrouplist,infosummarylist"];
...
- (void)groupInfoDataLoad:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"groupInfoDataLoad" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"loadError" forKey:@"error"];

 [args putValue:@"nc.bs.oa.oainf.ma.infopublish.OainfototalExtendController" forKey:@"viewid"];

 [args putValue:@"groupInfoDataLoad" forKey:@"action"];
...
[args setInvoke:[self getInvokeInfo:@"toInformation" method:@"toInformation" sender:sender]];
 ...
 [args putValue:@"cursorinitinfogrouplist_infosummarylistalias" forKey:@"cursor"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"#{#{cursor.cursorinitinfogrouplist_infosummarylistalias}}" forKey:@"row"];

 [args putValue:@"initinfogrouplist.infosummarylist" forKey:@"row_arrayPath"];
  [UMCompatible exec:sender container:self cursor:@"cursorinitinfogrouplist_infosummarylistalias"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)toColumnInfos:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toColumnInfos" method:@"UMView.open" sender:sender]];

 [args putValue:@"cursorinitinfogrouplist_infosummarylistalias" forKey:@"cursor"];

 [args putValue:@"info_columninfos" forKey:@"viewid"];
 ...
 [args putValue:@"initinfogrouplist" forKey:@"row_arrayPath"];
  [UMCompatible exec:sender container:self cursor:@"cursorinitinfogrouplist_infosummarylistalias"];
[UMCommonSevice callSeviceWithMethod:args];
