...
@interface addr_psnlistController ()
{
...
static NSString *controllerC = @"psnListController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_psnList addSubUMView:_viewPage0];
     //设置控件基本属性
...
- (void)getPhotoCallback:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"getPhotoCallback" method:@"getPhotoCallback" sender:sender]];
