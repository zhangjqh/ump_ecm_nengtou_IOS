...
#import "flow_forwardController.h"
...
@interface flow_forwardController ()
{
...
@implementation flow_forwardController
...
static NSString *controllerC = @"ForwardController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"ForwardDetail";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Forward addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_collaborationforward}"}];
...
// --flowLabel
    _flowLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_forwardto}"}];
...
// --contentLabel
    _contentLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.44705883",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_forwardopinion}"}];
...
// --contentArea
    _contentArea = [UMControl creatControl:@"UMXTextArea" container:self  params:@{
                          @"bindfield":@"opinion",
                          @"weight":@"1",
                          @"placeholder":@"#{res.flow_forwardplaceholder}",
                          @"width":@"0",
                          @"font_size":@"16",
                          @"txt_r":@"0.0",
                          @"id":@"contentArea",
...
// --attachmentLabel
    _attachmentLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_attachment}"}];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (isResum) {//第二次进入调用
        [self flowCallback:nil  args:nil];  
    }else {
        isResum = YES;
    }
...
[self umcontrol:_contentArea controlid:@"contentArea" bindfield:@"opinion"];
...
[args setInvoke:[self getInvokeInfo:@"submitFailed" method:@"UMView.openDialog" sender:sender]];
 ...
 [args putValue:@"#{res.flow_forwardfailed}" forKey:@"message"];
...
[args setInvoke:[self getInvokeInfo:@"submitSuccess" method:@"UMView.openDialog" sender:sender]];
 ...
 [args putValue:@"#{res.flow_forwardsuccess}" forKey:@"message"];
