#import "ecm_searchpgController_listView.h"
@interface ecm_searchpgController_listView_tableViewCell ()
{
	
}
@end
@implementation ecm_searchpgController_listView_tableViewCell
...
// --listView_childWgt0_groupName
    _listView_childWgt0_groupName = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"bindfield":@"name",
                          @"halign":@"left",
                          @"weight":@"1",
                          @"width":@"0",
                          @"font_size":@"16",
                          @"txt_r":@"0.0",
                          @"id":@"listView_childWgt0_groupName",
                          @"txt_g":@"0.0",
                          @"height":@"fill",
                          @"font_family":@"ArialMT",
                          @"color":@"#000000",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"GroupName"}];
    [(UMLayoutView*)_listView_childWgt0 addSubUMXView:_listView_childWgt0_groupName];

// --listView_childWgt0_groupNum
    _listView_childWgt0_groupNum = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"bindfield":@"num",
                          @"halign":@"right",
                          @"width":@"50",
                          @"font_size":@"14",
                          @"txt_r":@"0.5568628",
                          @"id":@"listView_childWgt0_groupNum",
                          @"txt_g":@"0.5568628",
                          @"height":@"fill",
                          @"font_family":@"ArialMT",
                          @"color":@"#8e8e93",
    ...
    [(UMLayoutView*)_listView_childWgt0 addSubUMXView:_listView_childWgt0_groupNum];

// --listView_childWgt0_groupSpace
    _listView_childWgt0_groupSpace = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"center",
                          @"width":@"15",
                          @"font_size":@"14",
                          @"txt_r":@"0.0",
                          @"id":@"listView_childWgt0_groupSpace",
                          @"txt_g":@"0.0",
                          @"height":@"fill",
                          @"color":@"#000000",
                          @"font_family":@"ArialMT",
                          ...
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@""}];
    [(UMLayoutView*)_listView_childWgt0 addSubUMXView:_listView_childWgt0_groupSpace];

// --listView_childWgt0_groupImg
    _listView_childWgt0_groupImg = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"listView_childWgt0_groupImg",
                          @"height":@"13",
                          @"width":@"8",
                          @"scaletype":@"fitcenter",
                          @"src":@"oa_ecm_right.png",@"value":@""}];
    [(UMLayoutView*)_listView_childWgt0 addSubUMXView:_listView_childWgt0_groupImg];
...
-(void)bindAll:(UMEntityContext *)_ctx{
	...
	[self umcontrol:_listView_childWgt0_groupName controlid:@"listView_childWgt0_groupName" bindfield:@"name"];
[self umcontrol:_listView_childWgt0_groupNum controlid:@"listView_childWgt0_groupNum" bindfield:@"num"];
...
@interface ecm_searchpgController_listView_group ()
{
	
}
@end
@implementation ecm_searchpgController_listView_group
...
@interface ecm_searchpgController_listView_cellHeight ()
{
	
}
@end
@implementation ecm_searchpgController_listView_cellHeight
