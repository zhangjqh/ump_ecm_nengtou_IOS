...
#import "addr_psnupdategroupController.h"
...
@interface addr_psnupdategroupController ()
{
...
@implementation addr_psnupdategroupController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize psnUpdateGroup = _psnUpdateGroup;
...
static NSString *controllerC = @"psnUpdateGroupController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_psnUpdateGroup addSubUMView:_viewPage0];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"onSave" method:@"onSave" sender:sender]];
 ...
 [args putValue:@"#{plug.psnjobid}" forKey:@"psnjobid"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"setChecked" method:@"setChecked" sender:sender]];
 ...
 [args putValue:@"persongroups" forKey:@"cindex_arrayPath"];

 [args putValue:@"#{cursor.cursorpersongroupsalias.index}" forKey:@"cindex"];
