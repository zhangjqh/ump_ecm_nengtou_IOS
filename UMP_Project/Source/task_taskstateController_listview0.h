...
@interface task_taskstateController_listview0_tableViewCell:LHTableViewCell

@property (strong) UMLayoutView* listview0_childWgt0;
- (UMLayoutView*)listview0_childWgt0 BV_OBJC_METHOD_FAMILY_NONE;

@property (strong) UMLayoutView* listview0_childWgt0_rounddiv0;
- (UMLayoutView*)listview0_childWgt0_rounddiv0 BV_OBJC_METHOD_FAMILY_NONE;
...
@interface task_taskstateController_listview0_group : LHGroup
...
@interface task_taskstateController_listview0_cellHeight : NSObject
@property (strong) UMLayoutView* listview0_childWgt0;
- (UMLayoutView*)listview0_childWgt0 BV_OBJC_METHOD_FAMILY_NONE;
