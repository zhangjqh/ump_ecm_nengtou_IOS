...
@interface scdu_shareschedulerdetailController ()
{
...
@implementation scdu_shareschedulerdetailController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize shareschedulerdetail = _shareschedulerdetail;
...
static NSString *controllerC = @"shareschedulerdetailController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _shareschedulerdetail = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_shareschedulerdetail addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.scdu_oascheduler_0062}"}];
