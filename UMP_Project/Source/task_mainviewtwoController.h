...
@interface task_mainviewtwoController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	mainviewtwo;
- (UMLayoutView*)mainviewtwo BV_OBJC_METHOD_FAMILY_NONE;
