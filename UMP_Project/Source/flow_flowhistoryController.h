...
@interface flow_flowhistoryController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	FlowHistory;
- (UMLayoutView*)FlowHistory BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* initactorPanel;
- (UMLayoutView*)initactorPanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* initactorLeftPanel;
- (UMLayoutView*)initactorLeftPanel BV_OBJC_METHOD_FAMILY_NONE;



@property (strong) UMLayoutView* initactorUpPanel;
- (UMLayoutView*)initactorUpPanel BV_OBJC_METHOD_FAMILY_NONE;

@property (strong) UMLayoutView* initactorDownPanel;
- (UMLayoutView*)initactorDownPanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* initactorLabel;


@property (nonatomic,strong) UMView* initactorSpaceLabel;

@property (nonatomic,strong) UMView* initactorImg;



@property (nonatomic,strong) UMView* initactorName;

@property (nonatomic,strong) UMView* initactorAction;

@property (nonatomic,strong) UMView* initactorCommit;

@property (nonatomic,strong) UMView* initactorDate;


@property (nonatomic,strong) UMView* transactorLabel;
