...
#import "scdu_myschedulerController.h"
...
@interface scdu_myschedulerController ()
{
...
@implementation scdu_myschedulerController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize myscheduler = _myscheduler;
...
static NSString *controllerC = @"myschedulerController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_myscheduler addSubUMView:_viewPage0];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"toMyScheduler" method:@"toMyScheduler" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)toAddScheduler:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toAddScheduler" method:@"UMView.open" sender:sender]];

 [args putValue:@"#{calendar.day}" forKey:@"daytime"];

 [args putValue:@"add" forKey:@"schtype"];

 [args putValue:@"scdu_addscheduler" forKey:@"viewid"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"monthchange" forKey:@"callback"];
...
[args setInvoke:[self getInvokeInfo:@"toShareScheduler" method:@"UMView.open" sender:sender]];

 [args putValue:@"scdu_sharescheduler" forKey:@"viewid"];
...
[args setInvoke:[self getInvokeInfo:@"login" method:@"UMService.login" sender:sender]];
 ...
 [args putValue:@"monthchange" forKey:@"success"];
[UMCommonSevice callSeviceWithMethod:args];
