...
static NSString *controllerC = @"info_textController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_info_text addSubUMView:_viewPage0];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"infoLoad" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"oneInfoLoad" forKey:@"action"];
