...
#import "addr_navgroupController.h"
...
@interface addr_navgroupController ()
{
...
static NSString *controllerC = @"navGroupController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"navList";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_navGroup addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.addr_oaadl_0004}"}];
...
// --search0
    _search0 = [UMControl creatControl:@"UMXSearchList" container:self  params:@{
                          @"placeholder":@"#{res.addr_oaadl_0027}",
                          @"localstorage":@"true",
                          @"font":@"ArialMT",
                          @"width":@"fill",
                          @"font_size":@"15",
    ...
    [(UMLayoutView*)_panel2 addSubUMXView:_search0];
...
[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"navs"];
...
[args setInvoke:[self getInvokeInfo:@"toPsnList" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"cursornavsalias" forKey:@"cursor"];
 ...
 [args putValue:@"nav" forKey:@"type"];

 [args putValue:@"#{#{cursor.cursornavsalias}}" forKey:@"row"];

 [args putValue:@"navs" forKey:@"row_arrayPath"];
  [UMCompatible exec:sender container:self cursor:@"cursornavsalias"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)toChildNav:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toChildNav" method:@"UMView.open" sender:sender]];

 [args putValue:@"cursornavsalias" forKey:@"cursor"];

 [args putValue:@"addr_navchildren" forKey:@"viewid"];
...
[args setInvoke:[self getInvokeInfo:@"toNavGroup" method:@"toNavGroup" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
