...
#import "scdu_timesetController.h"
...
@interface scdu_timesetController ()
{
...
static NSString *controllerC = @"timesetController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_timeset addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.scdu_title_set}"}];
...
[args setInvoke:[self getInvokeInfo:@"toTimeset" method:@"toTimeset" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
