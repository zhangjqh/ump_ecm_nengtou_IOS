...
@interface ecm_searchController ()
{
...
@implementation ecm_searchController
...
static NSString *controllerC = @"EcmSearchController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Search addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.ecm_searchperson}"}];
...
// --searchInput
    _searchInput = [UMControl creatControl:@"UMXSearchList" container:self  params:@{
                          @"localstorage":@"true",
    ...
    [(UMLayoutView*)_mainPanel addSubUMXView:_searchInput];
...
-(void)umload{
     ...
     [self loadCondition:nil  args:nil];
...
- (void)searchError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"searchError" method:@"searchError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)loadCondition:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"loadCondition" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"conditionError" forKey:@"error"];

 [args putValue:@"nc.bs.oa.oama.ecm.PersonController" forKey:@"viewid"];

 [args putValue:@"condition" forKey:@"action"];

 [args putValue:@"setCondition" forKey:@"callback"];
...
- (void)conditionError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"conditionError" method:@"conditionError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)setCondition:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"setCondition" method:@"setCondition" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)onSearchClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onSearchClick" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"searchError" forKey:@"error"];

 [args putValue:@"nc.bs.oa.oama.ecm.PersonController" forKey:@"viewid"];

 [args putValue:@"selectedCallback" forKey:@"callback"];

 [args putValue:@"search" forKey:@"action"];
