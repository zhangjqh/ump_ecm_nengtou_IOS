...
@interface task_refuseoragreeController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	refuseoragree;
- (UMLayoutView*)refuseoragree BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* title0;

@property (nonatomic,strong) UMView* reforagrbtn;
