...
@interface task_responserefcopyController ()
{
...
@implementation task_responserefcopyController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize responserefcopywin = _responserefcopywin;
...
static NSString *controllerC = @"responserefcopyController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _responserefcopywin = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_responserefcopywin addSubUMView:_viewPage0];
     //设置控件基本属性
