...
@interface info_searchinfosController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	searchinfos;
- (UMLayoutView*)searchinfos BV_OBJC_METHOD_FAMILY_NONE;
