...
@interface task_starttask_detailController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	starttask_detail;
- (UMLayoutView*)starttask_detail BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* rounddiv54;
- (UMLayoutView*)rounddiv54 BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* rounddiv64;
- (UMLayoutView*)rounddiv64 BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* label51;
