...
@interface flow_archivescanController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ArchiveScan;
- (UMLayoutView*)ArchiveScan BV_OBJC_METHOD_FAMILY_NONE;
