...
#import "task_attach_editController.h"
...
@interface task_attach_editController ()
{
...
@implementation task_attach_editController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize attach_edit = _attach_edit;
...
static NSString *controllerC = @"attach_editController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"filelist";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_attach_edit addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --attid
    _attid = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"center",
                          @"width":@"32",
                          @"font_size":@"14",
                          @"txt_r":@"0.0",
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{plug.attachmentuuid}"}];
    [(UMLayoutView*)_navigatorbar0 addSubUMXView:_attid];
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.task_attachmentList}"}];
...
[self umcontrol:_listviewdefine0 controlid:@"listviewdefine0" bindfield:@"attachment"];
...
- (void)uploadpic:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"uploadpic" method:@"UMService.uploadImage" sender:sender]];

 [args putValue:@"oapo" forKey:@"modulename"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"callloadmap" forKey:@"callback"];

 [args putValue:@"#{plug.attachmentuuid}" forKey:@"attachment"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)attload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"attload" method:@"addload" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)attclose:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"attclose" method:@"UMView.close" sender:sender]];

 [args putValue:@"#{attachment}" forKey:@"allrow"];
...
- (void)attdelete:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"attdelete" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"deleteAttachment" forKey:@"action"];

 [args putValue:@"#{ctl.listviewdefine0.row}" forKey:@"filerow"];

 [args putValue:@"true" forKey:@"autoDataBinding"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)downloadpic:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"downloadpic" method:@"UMService.downloadFile" sender:sender]];

 [args putValue:@"cursorattachmentalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.fileid}" forKey:@"downloadpath"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"0" forKey:@"startposition"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.fileid}" forKey:@"fileid"];

 [args putValue:@"1" forKey:@"downflag"];

 [args putValue:@"attachment" forKey:@"row_arrayPath"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}}" forKey:@"row"];

 [args putValue:@"oapo" forKey:@"modulename"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.filesize}" forKey:@"filesize"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.filename}" forKey:@"filename"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.filetype}" forKey:@"filetype"];

 [args putValue:@"0" forKey:@"endposition"];
  [UMCompatible exec:sender container:self cursor:@"cursorattachmentalias"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)callloadmap:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"callloadmap" method:@"callloadmap" sender:sender]];

 [args putValue:@"true" forKey:@"isDataCollect"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)attedit:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"attedit" method:@"attedit" sender:sender]];

 [args putValue:@"cursorattachmentalias" forKey:@"cursor"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"attachment" forKey:@"rowindex_arrayPath"];

 [args putValue:@"#{cursor.cursorattachmentalias.index}" forKey:@"rowindex"];
  [UMCompatible exec:sender container:self cursor:@"cursorattachmentalias"];
[UMCommonSevice callSeviceWithMethod:args];
