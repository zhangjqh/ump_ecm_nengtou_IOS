...
#import "flow_archiveeditController.h"
...
@interface flow_archiveeditController ()
{
...
@implementation flow_archiveeditController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize ArchiveEdit = _ArchiveEdit;
...
@synthesize folderPanel = _folderPanel;

@synthesize spaceOutPanel1 = _spaceOutPanel1;

@synthesize autoPanel = _autoPanel;
...
static NSString *controllerC = @"ArchiveEditController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ArchiveEdit addSubUMView:_basePanel];
     //设置控件基本属性
...
[UIApplication sharedApplication].keyWindow.backgroundColor = [_navigatorbar backgroundColor];
    ...
    [_leftPanel setContainer:self];
    [_leftPanel addEvent:@"onclick" actionName:@"onReturnBtnClick"];
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_archivesetting}"}];
    ...
    _folderPanel = [[UMLayoutView alloc] init];
    _folderPanel.controlId = @"folderPanel";
    _folderPanel.layoutType = Layout_hbox;
    [(UMLayoutView*)_mainPanel addSubUMView:_folderPanel];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_folderPanel info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"15",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"15",@"paddingRightUMP",
    ...
    _autoPanel = [[UMLayoutView alloc] init];
    _autoPanel.controlId = @"autoPanel";
    _autoPanel.layoutType = Layout_hbox;
    [(UMLayoutView*)_mainPanel addSubUMView:_autoPanel];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_autoPanel info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"15",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"15",@"paddingRightUMP",
...
// --folderLabel
    _folderLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"width":@"fill",
                          @"font_size":@"14",
                          @"txt_r":@"0.44705883",
                          ...
                          @"txt_b":@"0.44705883",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_archivefolder}"}];
    [(UMLayoutView*)_spaceInnerPanel addSubUMXView:_folderLabel];

// --folderTxt
    _folderTxt = [UMControl creatControl:@"UMXTextField" container:self  params:@{
                          @"bindfield":@"archiveset.folder",
                          @"padding-left":@"1",
                          @"weight":@"1",
                          @"placeholder":@"#{res.flow_archiveplaceholder}",
                          ...
                          @"txt_b":@"0.0",
                          @"readonly":@"true",
                          @"background-image":@"textbox",@"value":@""}];
    [(UMLayoutView*)_folderPanel addSubUMXView:_folderTxt];

// --folderSpaceLabel
    _folderSpaceLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"center",
                          @"width":@"15",
                          @"font_size":@"16",
                          @"txt_r":@"0.5568628",
                          ...
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@""}];
    [(UMLayoutView*)_folderPanel addSubUMXView:_folderSpaceLabel];

// --imgBtn
    _imgBtn = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"imgBtn",
                          @"height":@"13",
                          @"width":@"8",
                          @"scaletype":@"fitcenter",
                          @"src":@"ecm_arrow_right.png",@"value":@""}];
    [(UMLayoutView*)_folderPanel addSubUMXView:_imgBtn];
...
// --autoLabel
    _autoLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"weight":@"1",
                          @"width":@"0",
                          @"font_size":@"16",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_isauto}"}];
    [(UMLayoutView*)_autoPanel addSubUMXView:_autoLabel];

// --autoSpaceLabel
    _autoSpaceLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"right",
                          @"width":@"15",
                          @"font_size":@"16",
                          @"txt_r":@"0.5568628",
                          ...
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@""}];
    [(UMLayoutView*)_autoPanel addSubUMXView:_autoSpaceLabel];
...
// --switchBtn
    ...
    [(UMLayoutView*)_autoPanel addSubUMXView:_switchBtn];

    _spaceInnerPanel2 = [[UMLayoutView alloc] init];
    _spaceInnerPanel2.controlId = @"spaceInnerPanel2";
    _spaceInnerPanel2.layoutType = Layout_hbox;
...
[self umcontrol:_folderTxt controlid:@"folderTxt" bindfield:@"archiveset.folder"];
...
[self umcontrol:_switchBtn controlid:@"switchBtn" bindfield:@"archiveset.isauto"];
