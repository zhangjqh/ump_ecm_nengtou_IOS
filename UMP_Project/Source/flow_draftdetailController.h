...
@interface flow_draftdetailController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	DraftDetail;
- (UMLayoutView*)DraftDetail BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* spacePanel;
- (UMLayoutView*)spacePanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* submitPanel;
- (UMLayoutView*)submitPanel BV_OBJC_METHOD_FAMILY_NONE;

@property (strong) UMLayoutView* deletePanel;
- (UMLayoutView*)deletePanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* editBtn;
...
@property (nonatomic,strong) UMView* titleLabel;
...
@property (nonatomic,strong) UMView* deleteBtn;
