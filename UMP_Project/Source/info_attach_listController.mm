...
#import "info_attach_listController.h"
...
@interface info_attach_listController ()
{
...
@implementation info_attach_listController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize attach_list = _attach_list;
...
static NSString *controllerC = @"attach_listController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_attach_list addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.info_title_attach}"}];
...
[self umcontrol:_listviewdefine0 controlid:@"listviewdefine0" bindfield:@"attachlist"];
...
- (void)attachLoad:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"attachLoad" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"#{plug.infoid}" forKey:@"infoid"];

 [args putValue:@"nc.bs.oa.oainf.ma.infopublish.OneinfoExtendController" forKey:@"viewid"];

 [args putValue:@"oneInfoAttachmentsLoad" forKey:@"action"];
...
- (void)toOpenAttach:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toOpenAttach" method:@"UMService.downloadFile" sender:sender]];

 [args putValue:@"cursorattachlistalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorattachlistalias}.fileid}" forKey:@"downloadpath"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"0" forKey:@"startposition"];

 [args putValue:@"#{#{cursor.cursorattachlistalias}.fileid}" forKey:@"fileid"];

 [args putValue:@"1" forKey:@"downflag"];

 [args putValue:@"attachlist" forKey:@"row_arrayPath"];

 [args putValue:@"#{#{cursor.cursorattachlistalias}}" forKey:@"row"];

 [args putValue:@"" forKey:@"modulename"];

 [args putValue:@"#{#{cursor.cursorattachlistalias}.filesize}" forKey:@"filesize"];

 [args putValue:@"#{#{cursor.cursorattachlistalias}.filename}" forKey:@"filename"];

 [args putValue:@"#{#{cursor.cursorattachlistalias}.filletype}" forKey:@"filetype"];

 [args putValue:@"0" forKey:@"endposition"];
  [UMCompatible exec:sender container:self cursor:@"cursorattachlistalias"];
[UMCommonSevice callSeviceWithMethod:args];
