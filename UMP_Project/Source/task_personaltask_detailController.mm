...
@interface task_personaltask_detailController ()
{
...
@implementation task_personaltask_detailController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize personaltask_detail = _personaltask_detail;
...
static NSString *controllerC = @"personaltask_detailController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _personaltask_detail = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_personaltask_detail addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.task_personalTask}"}];
...
_Scrollview_panel11 = [[UMScrollView alloc] init];
    ...
    [(UMLayoutView*)_panel11 addSubUMView:_rounddiv9];
     //设置控件基本属性
    ...
    [_rounddiv9 addEvent:@"onclick" actionName:@"getattchment"];
...
// --label12
    _label12 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv0 addSubUMXView:_label12];
...
// --label13
    _label13 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv1 addSubUMXView:_label13];
...
// --label14
    _label14 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv2 addSubUMXView:_label14];
...
// --label15
    _label15 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv3 addSubUMXView:_label15];
...
// --label16
    _label16 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv5 addSubUMXView:_label16];
...
// --label8
    ...
    [(UMLayoutView*)_rounddiv6 addSubUMXView:_label8];
...
// --label17
    _label17 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv6 addSubUMXView:_label17];
...
// --label9
    ...
    [(UMLayoutView*)_rounddiv7 addSubUMXView:_label9];
...
// --label18
    _label18 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv7 addSubUMXView:_label18];

// --label29
    _label29 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"width":@"100",
                          @"font_size":@"14",
                          @"txt_r":@"0.0",
    ...
    [(UMLayoutView*)_rounddiv9 addSubUMXView:_label29];
...
// --label28
    _label28 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.8",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_rounddiv9 addSubUMXView:_label28];

// --button12
    _button12 = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          @"halign":@"center",
    ...
    [(UMLayoutView*)_rounddiv9 addSubUMXView:_button12];
...
[self umcontrol:_label12 controlid:@"label12" bindfield:@"startdate"];


[self umcontrol:_label13 controlid:@"label13" bindfield:@"enddate"];


[self umcontrol:_label14 controlid:@"label14" bindfield:@"taskname"];


[self umcontrol:_label15 controlid:@"label15" bindfield:@"taskcontent"];


[self umcontrol:_label6 controlid:@"label6" bindfield:@"completestandard"];


[self umcontrol:_label16 controlid:@"label16" bindfield:@"priority"];


[self umcontrol:_label17 controlid:@"label17" bindfield:@"taskstate"];


[self umcontrol:_label18 controlid:@"label18" bindfield:@"remark"];


[self umcontrol:_label28 controlid:@"label28" bindfield:@"count"];
...
- (void)beforeEdit:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"beforeEdit" method:@"beforeEdit" sender:sender]];
...
- (void)deletePsnTask:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"deletePsnTask" method:@"UMView.openDialog" sender:sender]];

 [args putValue:@"#{res.task_deletetaskpsn}" forKey:@"message"];
...
[args setInvoke:[self getInvokeInfo:@"deltask" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"delError" forKey:@"error"];
 ...
 [args putValue:@"delTask" forKey:@"action"];
...
- (void)delError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"delError" method:@"delError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)editpersonaltask:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"editpersonaltask" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"#{CONTEXT}" forKey:@"dada"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)returnforlist:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"returnforlist" method:@"UMView.open" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"poptip" method:@"UMView.openDialog" sender:sender]];
...
- (void)completetask:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"completetask" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"completeError" forKey:@"error"];

 [args putValue:@"nc.bs.oa.oama.oatask.ListviewController" forKey:@"viewid"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"completeTask" forKey:@"action"];

 [args putValue:@"completetasktip" forKey:@"callback"];
...
- (void)completetasktip:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"completetasktip" method:@"completetasktip" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)completeError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"completeError" method:@"completeError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
