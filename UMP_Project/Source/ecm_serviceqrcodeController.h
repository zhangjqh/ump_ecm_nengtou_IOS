...
@interface ecm_serviceqrcodeController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Ecm_Serviceqrcode;
- (UMLayoutView*)Ecm_Serviceqrcode BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* urlimage0;
