...
#import "scdu_monthrefController.h"
...
@interface scdu_monthrefController ()
{
...
static NSString *controllerC = @"monthrefController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_monthref addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"Serif",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.scdu_oascheduler_0027}"}];
...
[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"monthrefs"];
...
[args setInvoke:[self getInvokeInfo:@"onClickListRow" method:@"UMView.close" sender:sender]];
 ...
 [args putValue:@"monthrefs" forKey:@"result_arrayPath"];
...
[args setInvoke:[self getInvokeInfo:@"load" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"getMonthList" forKey:@"action"];
