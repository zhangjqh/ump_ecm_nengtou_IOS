...
#import "info_comment_listController.h"
...
@interface info_comment_listController ()
{
...
@implementation info_comment_listController
...
static NSString *controllerC = @"comment_listController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_comment_list addSubUMView:_viewPage0];
     //设置控件基本属性
...
[UIApplication sharedApplication].keyWindow.backgroundColor = [_navigatorbar0 backgroundColor];
    ...
    [(UMLayoutView*)_viewPage0 addSubUMView:_panel9];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.info_title_comment}"}];
...
// --listviewdefine0
    ...
    [(UMLayoutView*)_panel9 addSubUMView:_panel10];
     //设置控件基本属性
...
// --button1
    ...
    [(UMLayoutView*)_panel9 addSubUMXView:_button1];
...
// --textarea0
    _textarea0 = [UMControl creatControl:@"UMXTextArea" container:self  params:@{
                          ...
                          @"txt_b":@"0.972549",
                          @"bg_g":@"1.0",@"value":@""}];
    [(UMLayoutView*)_panel10 addSubUMXView:_textarea0];
...
[self commentsLoadFirstPage:nil  args:nil];
...
[self umcontrol:_listviewdefine0 controlid:@"listviewdefine0" bindfield:@"commentlist"];
...
- (void)showSuccessDialog:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"showSuccessDialog" method:@"UMView.openDialog" sender:sender]];

 [args putValue:@"#{res.info_dialog_text}" forKey:@"message"];

 [args putValue:@"#{res.info_dialog_title}" forKey:@"title"];

 [args putValue:@"null" forKey:@"style"];

 [args putValue:@"top-bottom" forKey:@"animation"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)commentsLoadNextPage:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"commentsLoadNextPage" method:@"UMList.getNextPage" sender:sender]];

 [args putValue:@"#{infoid}" forKey:@"infoid"];

 [args putValue:@"nc.bs.oa.oainf.ma.infopublish.OneinfoExtendController" forKey:@"viewid"];

 [args putValue:@"oneInfoCommentLoad" forKey:@"action"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)refreshList:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"refreshList" method:@"refreshList" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"gotoDetail" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"cursorcommentlistalias" forKey:@"cursor"];

 [args putValue:@"info_commentdetail" forKey:@"viewid"];

 [args putValue:@"true" forKey:@"iskeep"];

 [args putValue:@"commentlist" forKey:@"commentrow_arrayPath"];

 [args putValue:@"#{#{cursor.cursorcommentlistalias}}" forKey:@"commentrow"];
  [UMCompatible exec:sender container:self cursor:@"cursorcommentlistalias"];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)errorCallback:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"errorCallback" method:@"errorCallback" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)alertMsg:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"alertMsg" method:@"alertMsg" sender:sender]];

 [args putValue:@"true" forKey:@"isDataCollect"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)toCommentDetail:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"toCommentDetail" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"#{#{cursor.cursorcommentlistalias}.commentid}" forKey:@"commentid"];
 ...
 [args putValue:@"commentlist" forKey:@"commentid_arrayPath"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"gotoDetail" forKey:@"callback"];

 [args putValue:@"commentDetail" forKey:@"action"];
...
- (void)commentsLoadFirstPage:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"commentsLoadFirstPage" method:@"UMList.getFirstPage" sender:sender]];
