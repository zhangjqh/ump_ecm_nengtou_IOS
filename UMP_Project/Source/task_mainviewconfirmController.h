...
@interface task_mainviewconfirmController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	mainviewconfirm;
- (UMLayoutView*)mainviewconfirm BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* widget0_button1;
