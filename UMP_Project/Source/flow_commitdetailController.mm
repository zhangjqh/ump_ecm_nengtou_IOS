...
#import "flow_commitdetailController.h"
...
@interface flow_commitdetailController ()
{
...
@implementation flow_commitdetailController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize CommitDetail = _CommitDetail;
...
static NSString *controllerC = @"CommitDetailController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_CommitDetail addSubUMView:_basePanel];
     //设置控件基本属性
...
// --commitArea
    _commitArea = [UMControl creatControl:@"UMXTextArea" container:self  params:@{
                          @"padding-right":@"15",
                          @"padding-left":@"15",
                          @"padding-top":@"5",
                          @"width":@"fill",
                          ...
                          @"readonly":@"true",
                          @"bg_g":@"1.0",@"value":@""}];
    [(UMLayoutView*)_mainPanel addSubUMXView:_commitArea];
