...
@interface flow_archiveeditController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	ArchiveEdit;
- (UMLayoutView*)ArchiveEdit BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* folderPanel;
- (UMLayoutView*)folderPanel BV_OBJC_METHOD_FAMILY_NONE;

@property (strong) UMLayoutView* spaceOutPanel1;
- (UMLayoutView*)spaceOutPanel1 BV_OBJC_METHOD_FAMILY_NONE;

@property (strong) UMLayoutView* autoPanel;
- (UMLayoutView*)autoPanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* folderLabel;

@property (nonatomic,strong) UMView* folderTxt;

@property (nonatomic,strong) UMView* folderSpaceLabel;

@property (nonatomic,strong) UMView* imgBtn;


@property (nonatomic,strong) UMView* autoLabel;

@property (nonatomic,strong) UMView* autoSpaceLabel;
