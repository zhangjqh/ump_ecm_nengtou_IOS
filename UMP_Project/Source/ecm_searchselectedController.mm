...
#import "ecm_searchselectedController.h"
...
@interface ecm_searchselectedController ()
{
...
@implementation ecm_searchselectedController
...
static NSString *controllerC = @"EcmSearchSelectedController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_SearchSelected addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_selectedlist}"}];
    [(UMLayoutView*)_centerPanel addSubUMXView:_navLabel];

// --okBtn
    _okBtn = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          @"halign":@"right",
                          @"p_txt_r":@"0.9490196",
                          @"width":@"fill",
                          @"font_size":@"17",
                          ...
                          @"valign":@"center",
                          @"p_txt_g":@"0.6784314"}];
    [(UMLayoutView*)_rightPanel addSubUMXView:_okBtn];
