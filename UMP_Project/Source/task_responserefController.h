...
@interface task_responserefController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	responserefwin;
- (UMLayoutView*)responserefwin BV_OBJC_METHOD_FAMILY_NONE;
