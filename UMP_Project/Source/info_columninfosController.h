...
@interface info_columninfosController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	columninfos;
- (UMLayoutView*)columninfos BV_OBJC_METHOD_FAMILY_NONE;
