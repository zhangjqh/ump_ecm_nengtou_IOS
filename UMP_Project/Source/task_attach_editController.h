...
@interface task_attach_editController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	attach_edit;
- (UMLayoutView*)attach_edit BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* attid;
