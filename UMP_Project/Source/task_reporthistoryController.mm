...
#import "task_reporthistoryController.h"
...
@interface task_reporthistoryController ()
{
...
@implementation task_reporthistoryController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize Task_reporthistory = _Task_reporthistory;
...
static NSString *controllerC = @"Task_reporthistoryController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"reporthistest";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _Task_reporthistory = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Task_reporthistory addSubUMView:_viewPage0];
     //设置控件基本属性
...
-(void)umload{
     ...
     [self loadreporthistory:nil  args:nil];
...
[self umcontrol:_listviewdefine0 controlid:@"listviewdefine0" bindfield:@"reporthisList.reporthistory,completion"];
...
- (void)attachmentlist:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"attachmentlist" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"#{ctl.listviewdefine0.row}" forKey:@"row"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)closehistory:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"closehistory" method:@"UMView.close" sender:sender]];

 [args putValue:@"0" forKey:@"resultcode"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)progressbar0_onload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"progressbar0_onload" method:@"this.progressbar0_onload()" sender:sender]];
...
- (void)loadreporthistory:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"loadreporthistory" method:@"loadreporthistory" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"listviewdefine0_onload" method:@"this.listviewdefine0_onload()" sender:sender]];
...
- (void)panel2_onload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"panel2_onload" method:@"this.panel2_onload()" sender:sender]];
