...
@interface scdu_onerepeatdayrefController ()
{
...
@implementation scdu_onerepeatdayrefController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize onerepeatdayref = _onerepeatdayref;
...
static NSString *controllerC = @"onerepeatdayrefController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"repeatRull1";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_onerepeatdayref addSubUMView:_viewPage0];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"onClickListRow" method:@"UMView.close" sender:sender]];
 ...
 [args putValue:@"repeatdayresfs" forKey:@"result_arrayPath"];
