...
@interface ecm_searchdeptController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	SearchDept;
- (UMLayoutView*)SearchDept BV_OBJC_METHOD_FAMILY_NONE;
