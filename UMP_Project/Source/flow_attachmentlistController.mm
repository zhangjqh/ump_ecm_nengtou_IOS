...
#import "flow_attachmentlistController.h"
...
@interface flow_attachmentlistController ()
{
...
@implementation flow_attachmentlistController
...
static NSString *controllerC = @"AttachmentListController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_AttachmentList addSubUMView:_basePanel];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"onItemClick" method:@"UMService.downloadFile" sender:sender]];

 [args putValue:@"cursorattachmentalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.id}" forKey:@"downloadpath"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"0" forKey:@"startposition"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.id}" forKey:@"fileid"];
 ...
 [args putValue:@"#{#{cursor.cursorattachmentalias}.size}" forKey:@"filesize"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.name}" forKey:@"filename"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.type}" forKey:@"filetype"];
