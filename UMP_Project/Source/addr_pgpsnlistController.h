...
@interface addr_pgpsnlistController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	pgPsnList;
- (UMLayoutView*)pgPsnList BV_OBJC_METHOD_FAMILY_NONE;
