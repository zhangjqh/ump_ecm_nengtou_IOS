...
@interface msg_readmessagelistController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	msg_ReadMessageList;
- (UMLayoutView*)msg_ReadMessageList BV_OBJC_METHOD_FAMILY_NONE;
