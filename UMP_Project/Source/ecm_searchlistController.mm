...
#import "ecm_searchlistController.h"
...
@interface ecm_searchlistController ()
{
...
@implementation ecm_searchlistController
...
static NSString *controllerC = @"EcmSearchListController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_SearchList addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{plug.uppername}"}];
...
[args setInvoke:[self getInvokeInfo:@"onDataLoad" method:@"UMList.getFirstPage" sender:sender]];
 ...
 [args putValue:@"#{plug.action}" forKey:@"action"];

 [args putValue:@"#{plug.upperid}" forKey:@"upperid"];
...
[args setInvoke:[self getInvokeInfo:@"onDownRefresh" method:@"UMList.getNextPage" sender:sender]];
 ...
 [args putValue:@"refreshError" forKey:@"error"];
...
- (void)onDownRefreshFive:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onDownRefreshFive" method:@"UMList.getNextPage" sender:sender]];
...
- (void)onDataLoadFive:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onDataLoadFive" method:@"UMList.getFirstPage" sender:sender]];
...
- (void)onOkBtnClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onOkBtnClick" method:@"UMView.close" sender:sender]];

 [args putValue:@"15" forKey:@"resultcode"];

 [args putValue:@"false" forKey:@"iskeep"];

 [args putValue:@"close" forKey:@"returntype"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)refreshError:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"refreshError" method:@"refreshError" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
