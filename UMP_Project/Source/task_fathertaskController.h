...
@interface task_fathertaskController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	fathertaskwin;
- (UMLayoutView*)fathertaskwin BV_OBJC_METHOD_FAMILY_NONE;
