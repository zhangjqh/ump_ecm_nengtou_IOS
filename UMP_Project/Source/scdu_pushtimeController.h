...
@interface scdu_pushtimeController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	pushtime;
- (UMLayoutView*)pushtime BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* timeinput0;

@property (nonatomic,strong) UMView* label3;

@property (nonatomic,strong) UMView* timeinput1;
