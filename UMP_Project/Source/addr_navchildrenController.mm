...
#import "addr_navchildrenController.h"
...
@interface addr_navchildrenController ()
{
...
@implementation addr_navchildrenController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize navChildren = _navChildren;
...
static NSString *controllerC = @"navChildrenController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_navChildren addSubUMView:_viewPage0];
     //设置控件基本属性
