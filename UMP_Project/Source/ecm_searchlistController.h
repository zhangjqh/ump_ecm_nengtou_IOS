...
@interface ecm_searchlistController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	SearchList;
- (UMLayoutView*)SearchList BV_OBJC_METHOD_FAMILY_NONE;
