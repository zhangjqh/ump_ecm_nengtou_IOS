...
@interface msg_attachmentlistController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Msg_AttachmentList;
- (UMLayoutView*)Msg_AttachmentList BV_OBJC_METHOD_FAMILY_NONE;
