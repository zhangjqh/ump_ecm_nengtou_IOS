...
@interface ecm_searchController_listView_tableViewCell:LHTableViewCell
...
@interface ecm_searchController_listView_group : LHGroup
...
@interface ecm_searchController_listView_cellHeight : NSObject
@property (strong) UMLayoutView* listView_childWgt0;
- (UMLayoutView*)listView_childWgt0 BV_OBJC_METHOD_FAMILY_NONE;
