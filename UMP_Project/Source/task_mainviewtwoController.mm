...
#import "task_mainviewtwoController.h"
...
@interface task_mainviewtwoController ()
{
...
@implementation task_mainviewtwoController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize mainviewtwo = _mainviewtwo;
...
static NSString *controllerC = @"mainviewtwoController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_mainviewtwo addSubUMView:_viewPage0];
     //设置控件基本属性
...
[UIApplication sharedApplication].keyWindow.backgroundColor = [_navigatorbar1 backgroundColor];
    ...
    [(UMLayoutView*)_navigatorbar0 addSubUMView:_widget0];
     //设置控件基本属性
...
// --widget0_button1
    _widget0_button1 = [UMControl creatControl:@"UMXButton" container:self  params:@{
                          @"halign":@"center",
                          @"p_txt_r":@"0.9490196",
                          @"width":@"64",
                          @"font_size":@"17",
    ...
    [(UMLayoutView*)_widget0_leftPanel addSubUMXView:_widget0_button1];
...
// --widget0_togglebutton0
    _widget0_togglebutton0 = [UMControl creatControl:@"UMXToggleButton" container:self  params:@{
                          ...
                          @"font_size":@"14",
                          @"textoff":@"#{res.task_tobeconfirmed}",
...
// --widget0_button0
    ...
    [(UMLayoutView*)_widget0_rightPanel addSubUMXView:_widget0_button0];
...
// --listview0
    ...
    [(UMLayoutView*)_navigatorbar1 addSubUMView:_widget1];
     //设置控件基本属性
...
-(void)umload{
     ...
     [self initbtnclick:nil  args:nil];


[self getfirstpage:nil  args:nil];
...
- (void)querytasklist:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"querytasklist" method:@"querytasklist" sender:sender]];
...
- (void)tasklistonload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"tasklistonload" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"nc.bs.oa.oama.oatask.ListviewController" forKey:@"viewid"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"getTaskList" forKey:@"action"];

 [args putValue:@"true" forKey:@"autoDataBinding"];

 [args putValue:@"{tasktype:'4'}" forKey:@"params"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"showItemClick" method:@"showItemClick" sender:sender]];
 ...
 [args putValue:@"tasklist" forKey:@"taskid_arrayPath"];

 [args putValue:@"cursortasklistalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursortasklistalias}}" forKey:@"taskid"];
...
[args setInvoke:[self getInvokeInfo:@"mypublish" method:@"mypublish" sender:sender]];
...
[args setInvoke:[self getInvokeInfo:@"mytask" method:@"UMView.open" sender:sender]];
...
- (void)initbtnclick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"initbtnclick" method:@"initbtnclick" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)confirm:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"confirm" method:@"UMView.open" sender:sender]];

 [args putValue:@"task_mainviewconfirm" forKey:@"viewid"];
