...
@interface addr_navchildrenController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	navChildren;
- (UMLayoutView*)navChildren BV_OBJC_METHOD_FAMILY_NONE;
