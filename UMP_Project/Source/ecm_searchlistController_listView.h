...
@interface ecm_searchlistController_listView_tableViewCell:LHTableViewCell
...
@property (strong) UMLayoutView* listView_childWgt2;
- (UMLayoutView*)listView_childWgt2 BV_OBJC_METHOD_FAMILY_NONE;





@property (strong) UMLayoutView* listView_childWgt3;
- (UMLayoutView*)listView_childWgt3 BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* listView_childWgt2_orgName;

@property (nonatomic,strong) UMView* listView_childWgt2_orgNum;

@property (nonatomic,strong) UMView* listView_childWgt2_orgSpace;

@property (nonatomic,strong) UMView* listView_childWgt2_orgImg;


@property (nonatomic,strong) UMView* listView_childWgt3_empLabel;

@property (nonatomic,strong) UMView* listView_childWgt3_empNum;

@property (nonatomic,strong) UMView* listView_childWgt3_empSpace;

@property (nonatomic,strong) UMView* listView_childWgt3_empImg;
...
@interface ecm_searchlistController_listView_group : LHGroup
...
@interface ecm_searchlistController_listView_cellHeight : NSObject
@property (strong) UMLayoutView* listView_childWgt0;
- (UMLayoutView*)listView_childWgt0 BV_OBJC_METHOD_FAMILY_NONE;
