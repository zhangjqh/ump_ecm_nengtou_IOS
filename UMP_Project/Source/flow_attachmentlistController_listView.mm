#import "flow_attachmentlistController_listView.h"
@interface flow_attachmentlistController_listView_tableViewCell ()
{
	
}
@end
@implementation flow_attachmentlistController_listView_tableViewCell
...
// --nameTxt
    ...
    [(UMLayoutView*)_itemPanel addSubUMXView:_nameTxt];

// --sizeTxt
    _sizeTxt = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"bindfield":@"sizeshow",
                          @"halign":@"right",
                          @"width":@"100",
                          @"font_size":@"16",
    ...
    [(UMLayoutView*)_itemPanel addSubUMXView:_sizeTxt];
...
[self umcontrol:_sizeTxt controlid:@"sizeTxt" bindfield:@"sizeshow"];
...
@interface flow_attachmentlistController_listView_group ()
{
	
}
@end
@implementation flow_attachmentlistController_listView_group
...
@interface flow_attachmentlistController_listView_cellHeight ()
{
	
}
@end
@implementation flow_attachmentlistController_listView_cellHeight
