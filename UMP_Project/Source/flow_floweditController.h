...
@interface flow_floweditController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	FlowEdit;
- (UMLayoutView*)FlowEdit BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* addOutPanel;
- (UMLayoutView*)addOutPanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* addInnerPanel;
- (UMLayoutView*)addInnerPanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* stepLabel;
