...
@interface task_taskstateController ()
{
...
@implementation task_taskstateController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize taskstateref = _taskstateref;
...
static NSString *controllerC = @"task_taskstateController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"taskstateenum";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_taskstateref addSubUMView:_viewPage0];
     //设置控件基本属性
...
[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"enumlist"];
...
[args setInvoke:[self getInvokeInfo:@"onClickListRow" method:@"UMView.close" sender:sender]];
 ...
 [args putValue:@"#{#{cursor.cursorenumlistalias}}" forKey:@"result"];

 [args putValue:@"enumlist" forKey:@"result_arrayPath"];

 [args putValue:@"cursorenumlistalias" forKey:@"cursor"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"15" forKey:@"resultCode"];
  [UMCompatible exec:sender container:self cursor:@"cursorenumlistalias"];
...
[args setInvoke:[self getInvokeInfo:@"load" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"getEnumList" forKey:@"action"];

 [args putValue:@"true" forKey:@"autoDataBinding"];

 [args putValue:@"{\"enumtype\":\"2\"}" forKey:@"params"];
[UMCommonSevice callSeviceWithMethod:args];
