...
#import "info_columninfosController.h"
...
@interface info_columninfosController ()
{
...
@implementation info_columninfosController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize columninfos = _columninfos;
...
static NSString *controllerC = @"columninfosController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_columninfos addSubUMView:_viewPage0];
     //设置控件基本属性
...
[self columnInfoFirstPage:nil  args:nil];
...
[self umcontrol:_label0 controlid:@"label0" bindfield:@"columnname"];
...
- (void)columnInfoNextPage:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"columnInfoNextPage" method:@"UMList.getNextPage" sender:sender]];

 [args putValue:@"nc.bs.oa.oainf.ma.infopublish.OainflistExtendController" forKey:@"viewid"];

 [args putValue:@"true" forKey:@"isDataCollect"];

 [args putValue:@"columnInfoNextPage" forKey:@"action"];
...
[args setInvoke:[self getInvokeInfo:@"toInformation" method:@"toInformation" sender:sender]];
 ...
 [args putValue:@"oainfs" forKey:@"inforrow_arrayPath"];

 [args putValue:@"#{#{cursor.cursoroainfsalias}}" forKey:@"inforrow"];
...
[args setInvoke:[self getInvokeInfo:@"toGroupInfos" method:@"UMView.close" sender:sender]];

 [args putValue:@"0" forKey:@"resultcode"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)columnInfoFirstPage:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"columnInfoFirstPage" method:@"UMList.getFirstPage" sender:sender]];
 ...
 [args putValue:@"columnInfoFirstPage" forKey:@"action"];
