...
#import "ecm_qrcodecontextController.h"
...
@interface ecm_qrcodecontextController ()
{
...
@implementation ecm_qrcodecontextController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize Ecm_Qrcodecontext = _Ecm_Qrcodecontext;
...
static NSString *controllerC = @"Ecm_QrcodecontextController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _Ecm_Qrcodecontext = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Ecm_Qrcodecontext addSubUMView:_viewPage0];
     //设置控件基本属性
    ...
    _navigatorbar0.naviTitle = [UMParser parseExpr:nil expr:@"扫描结果" ctx:_ctx];;
...
// --textarea1
    _textarea1 = [UMControl creatControl:@"UMXTextArea" container:self  params:@{
                          @"bindfield":@"key",
                          @"padding-left":@"4",
                          @"padding-top":@"14",
                          @"halign":@"CENTER",
                          ...
                          @"txt_b":@"0.972549",
                          @"bg_g":@"1.0",@"value":@""}];
    [(UMLayoutView*)_panel0 addSubUMXView:_textarea1];
...
-(void)umload{
     ...
     [self qrcodecontext:nil  args:nil];
...
[self umcontrol:_textarea1 controlid:@"textarea1" bindfield:@"key"];
...
- (void)qrcodecontext:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"qrcodecontext" method:@"qrcodecontext" sender:sender]];

 [args putValue:@"#{plug.key}" forKey:@"qrcodekey"];
...
[args setInvoke:[self getInvokeInfo:@"closewin" method:@"UMView.close" sender:sender]];
