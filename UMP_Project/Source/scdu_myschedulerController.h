...
@interface scdu_myschedulerController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	myscheduler;
- (UMLayoutView*)myscheduler BV_OBJC_METHOD_FAMILY_NONE;
