...
#import "task_fathertaskController.h"
...
@interface task_fathertaskController ()
{
...
@implementation task_fathertaskController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize fathertaskwin = _fathertaskwin;
...
static NSString *controllerC = @"fathertaskController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_fathertaskwin addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.task_fatherList}"}];
...
[args setInvoke:[self getInvokeInfo:@"onClickListRow" method:@"UMView.close" sender:sender]];
 ...
 [args putValue:@"#{#{cursor.cursortasklistalias}}" forKey:@"result"];

 [args putValue:@"tasklist" forKey:@"result_arrayPath"];
...
[args setInvoke:[self getInvokeInfo:@"load" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"{\"tasktype\":\"5\"}" forKey:@"params"];
[UMCommonSevice callSeviceWithMethod:args];
