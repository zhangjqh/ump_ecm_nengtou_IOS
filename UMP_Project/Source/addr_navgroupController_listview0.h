...
@interface addr_navgroupController_listview0_tableViewCell:LHTableViewCell
...
@property (nonatomic,strong) UMView* listview0_childWgt0_image8;
...
@property (nonatomic,strong) UMView* listview0_childWgt1_image9;

@property (nonatomic,strong) UMView* listview0_childWgt1_label3;


@property (nonatomic,strong) UMView* listview0_childWgt2_image10;
...
@interface addr_navgroupController_listview0_group : LHGroup
...
@interface addr_navgroupController_listview0_cellHeight : NSObject
@property (strong) UMLayoutView* listview0_childWgt0;
- (UMLayoutView*)listview0_childWgt0 BV_OBJC_METHOD_FAMILY_NONE;
