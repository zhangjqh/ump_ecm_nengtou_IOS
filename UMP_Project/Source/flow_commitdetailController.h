...
@interface flow_commitdetailController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	CommitDetail;
- (UMLayoutView*)CommitDetail BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* commitArea;
