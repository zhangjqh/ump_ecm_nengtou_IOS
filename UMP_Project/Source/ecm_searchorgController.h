...
@interface ecm_searchorgController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	SearchOrg;
- (UMLayoutView*)SearchOrg BV_OBJC_METHOD_FAMILY_NONE;
