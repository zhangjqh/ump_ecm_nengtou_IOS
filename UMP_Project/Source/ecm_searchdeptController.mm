...
#import "ecm_searchdeptController.h"
...
@interface ecm_searchdeptController ()
{
...
@implementation ecm_searchdeptController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize SearchDept = _SearchDept;
...
static NSString *controllerC = @"EcmSearchDeptController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_SearchDept addSubUMView:_basePanel];
     //设置控件基本属性
...
- (void)onOrgBtnClick:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"onOrgBtnClick" method:@"UMView.open" sender:sender]];

 [args putValue:@"ecm_searchorg" forKey:@"viewid"];

 [args putValue:@"false" forKey:@"iskeep"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)catcherror:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"catcherror" method:@"catcherror" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
- (void)loadCallback:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"loadCallback" method:@"loadCallback" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"loadData" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"catcherror" forKey:@"error"];

 [args putValue:@"nc.bs.oa.oama.ecm.PersonController" forKey:@"viewid"];

 [args putValue:@"list" forKey:@"action"];

 [args putValue:@"loadCallback" forKey:@"callback"];
