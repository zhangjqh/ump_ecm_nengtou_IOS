...
@interface task_reporthistoryController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Task_reporthistory;
- (UMLayoutView*)Task_reporthistory BV_OBJC_METHOD_FAMILY_NONE;
