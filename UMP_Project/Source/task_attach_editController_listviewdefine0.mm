#import "task_attach_editController_listviewdefine0.h"
@interface task_attach_editController_listviewdefine0_tableViewCell ()
{
	
}
@end
@implementation task_attach_editController_listviewdefine0_tableViewCell
          ...
          case 0:
{
    ...
    [UMCompatible initCommonProperty:_panel1 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          ...
                          @"oatask_list_split.png",@"backgroundImagePath",
    ...
    [_panel1 addEvent:@"onclick" actionName:@"downloadpic"];
...
-(void)bindAll:(UMEntityContext *)_ctx{
	...
	[self umcontrol:_label1 controlid:@"label1" bindfield:@"filename"];
[self umcontrol:_label2 controlid:@"label2" bindfield:@"filesize"];
...
@interface task_attach_editController_listviewdefine0_group ()
{
	
}
@end
@implementation task_attach_editController_listviewdefine0_group
...
@interface task_attach_editController_listviewdefine0_cellHeight ()
{
	
}
@end
@implementation task_attach_editController_listviewdefine0_cellHeight
