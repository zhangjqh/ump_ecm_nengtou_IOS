...
@interface scdu_sharedgrouopController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	sharedgrouop;
- (UMLayoutView*)sharedgrouop BV_OBJC_METHOD_FAMILY_NONE;
