...
#import "msg_readmessagelistController.h"
...
@interface msg_readmessagelistController ()
{
...
@implementation msg_readmessagelistController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize msg_ReadMessageList = _msg_ReadMessageList;
...
static NSString *controllerC = @"msg_ReadMessageListController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _msg_ReadMessageList = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_msg_ReadMessageList addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.msg_ReadMessage}"}];
...
[self OnLoadReadMsgData:nil args:nil];
...
[args setInvoke:[self getInvokeInfo:@"onDownRefresh" method:@"UMList.getNextPage" sender:sender]];
 ...
 [args putValue:@"readed" forKey:@"isread"];
...
[args setInvoke:[self getInvokeInfo:@"GoToDetail" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"OnLoadReadMsgData" forKey:@"callback"];
...
- (void)OnLoadReadMsgData:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"OnLoadReadMsgData" method:@"UMList.getFirstPage" sender:sender]];
