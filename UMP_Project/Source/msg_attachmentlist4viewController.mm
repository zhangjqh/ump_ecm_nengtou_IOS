...
@interface msg_attachmentlist4viewController ()
{
...
@implementation msg_attachmentlist4viewController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize Msg_AttachmentList4View = _Msg_AttachmentList4View;
...
static NSString *controllerC = @"Msg_AttachmentList4ViewController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _Msg_AttachmentList4View = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Msg_AttachmentList4View addSubUMView:_basePanel];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"OnLoadData" method:@"UMList.getFirstPage" sender:sender]];

 [args putValue:@"#{plug.msgid}" forKey:@"msgid"];
 ...
 [args putValue:@"GetAttachmentList" forKey:@"action"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)OpenFile:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"OpenFile" method:@"UMService.downloadFile" sender:sender]];

 [args putValue:@"cursorattachmentlistalias" forKey:@"cursor"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.id}" forKey:@"downloadpath"];

 [args putValue:@"0" forKey:@"startposition"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.id}" forKey:@"fileid"];

 [args putValue:@"attachmentlist" forKey:@"currentid_arrayPath"];

 [args putValue:@"1" forKey:@"downflag"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.id}" forKey:@"currentid"];

 [args putValue:@"oaco" forKey:@"modulename"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.sizeshow}" forKey:@"filesize"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.name}" forKey:@"filename"];

 [args putValue:@"#{#{cursor.cursorattachmentlistalias}.type}" forKey:@"filetype"];
