...
#import "flow_flowscanController.h"
...
@interface flow_flowscanController ()
{
...
static NSString *controllerC = @"FlowScanController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_FlowScan addSubUMView:_basePanel];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"onItemClick" method:@"UMView.open" sender:sender]];
 ...
 [args putValue:@"flow_stepscan" forKey:@"viewid"];
