...
@interface flow_templatelistController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	TemplateList;
- (UMLayoutView*)TemplateList BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* rangePanel;
- (UMLayoutView*)rangePanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* rangeLabel;
