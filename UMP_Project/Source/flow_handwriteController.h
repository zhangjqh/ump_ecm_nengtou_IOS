...
@interface flow_handwriteController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	HandWrite;
- (UMLayoutView*)HandWrite BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* handImg;
