...
@synthesize panel808 = _panel808;

@synthesize panel0999 = _panel0999;
...
@synthesize flipper0_childWgt0_panel1 = _flipper0_childWgt0_panel1;

@synthesize flipper0_childWgt0_panel2 = _flipper0_childWgt0_panel2;
...
static NSString *controllerC = @"info_imgController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_info_img addSubUMView:_viewPage0];
     //设置控件基本属性
...
[UIApplication sharedApplication].keyWindow.backgroundColor = [_navigatorbar0 backgroundColor];
    ...
    _panel808 = [[UMLayoutView alloc] init];
    _panel808.controlId = @"panel808";
    _panel808.layoutType = Layout_vbox;
    [(UMLayoutView*)_viewPage0 addSubUMView:_panel808];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_panel808 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"10",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"10",@"paddingRightUMP",
    ...
    _panel0999 = [[UMLayoutView alloc] init];
    _panel0999.controlId = @"panel0999";
    _panel0999.layoutType = Layout_hbox;
    [(UMLayoutView*)_viewPage0 addSubUMView:_panel0999];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_panel0999 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"10",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"10",@"paddingRightUMP",
    ...
    [(UMLayoutView*)_viewPage0 addSubUMView:_panel5];
     //设置控件基本属性
...
// --label3
    _label3 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_panel808 addSubUMXView:_label3];

    _panel1 = [[UMLayoutView alloc] init];
    _panel1.controlId = @"panel1";
    _panel1.layoutType = Layout_vbox;
    [(UMLayoutView*)_panel0999 addSubUMView:_panel1];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel0999 addSubUMView:_panel6];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_panel0999 addSubUMView:_panel7];
     //设置控件基本属性
...
// --image1
    _image1 = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          ...
                          @"onclick":@"nextImgLoad",
                          @"scaletype":@"fitcenter",
                          @"src":@"oainf_l.png",@"value":@""}];
    [(UMLayoutView*)_panel1 addSubUMXView:_image1];
...
// --image2
    _image2 = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          ...
                          @"onclick":@"preImgLoad",
                          @"scaletype":@"fitcenter",
                          @"src":@"oainf_r.png",@"value":@""}];
    [(UMLayoutView*)_panel7 addSubUMXView:_image2];
...
// --flipper0
    _flipper0 = [UMControl creatControl:@"UMXViewFlipper" container:self  params:@{
                          ...
                          @"width":@"0",
                          @"flippertype":@"dynamic",@"value":@"                             "}];
    [(UMLayoutView*)_panel5 addSubUMXView:_flipper0];
...
[_flipper0 addView:_flipper0_childWgt0];
    ...
    _flipper0_childWgt0_panel1 = [[UMLayoutView alloc] init];
    _flipper0_childWgt0_panel1.controlId = @"flipper0_childWgt0_panel1";
    _flipper0_childWgt0_panel1.layoutType = Layout_vbox;
    [(UMLayoutView*)_flipper0_childWgt0 addSubUMView:_flipper0_childWgt0_panel1];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_flipper0_childWgt0_panel1 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"1",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
    ...
    _flipper0_childWgt0_panel2 = [[UMLayoutView alloc] init];
    _flipper0_childWgt0_panel2.controlId = @"flipper0_childWgt0_panel2";
    _flipper0_childWgt0_panel2.layoutType = Layout_vbox;
    [(UMLayoutView*)_flipper0_childWgt0 addSubUMView:_flipper0_childWgt0_panel2];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_flipper0_childWgt0_panel2 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"0",@"paddingLeftUMP",
                          @"5",@"paddingTopUMP",
                          @"0",@"paddingRightUMP",
...
// --flipper0_childWgt0_image0
    _flipper0_childWgt0_image0 = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"bindfield":@"imgfilecontent",
                          @"id":@"flipper0_childWgt0_image0",
                          @"height":@"fill",
                          @"width":@"fill",
                          @"scaletype":@"fitcenter",
                          @"src":@"",@"value":@""}];
    [(UMLayoutView*)_flipper0_childWgt0_panel1 addSubUMXView:_flipper0_childWgt0_image0];

// --flipper0_childWgt0_label0
    _flipper0_childWgt0_label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",@"value":@""}];
    [(UMLayoutView*)_flipper0_childWgt0_panel2 addSubUMXView:_flipper0_childWgt0_label0];
...
[self umcontrol:_label5 controlid:@"label5" bindfield:@"imgposition"];
...
[self umcontrol:_flipper0_childWgt0_image0 controlid:@"flipper0_childWgt0_image0" bindfield:@"imgfilecontent"];

[self umcontrol:_flipper0_childWgt0_label0 controlid:@"flipper0_childWgt0_label0" bindfield:@"imgfiledesc"];
...
- (void)preImgLoad:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"preImgLoad" method:@"preImgLoad" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)nextImgLoad:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"nextImgLoad" method:@"nextImgLoad" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"infoLoad" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"#{plug.screenh}" forKey:@"screenh"];

 [args putValue:@"#{plug.screenw}" forKey:@"screenw"];

 [args putValue:@"onePicLoad" forKey:@"action"];
...
- (void)textarea0_onchange:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"textarea0_onchange" method:@"this.textarea0_onchange()" sender:sender]];
