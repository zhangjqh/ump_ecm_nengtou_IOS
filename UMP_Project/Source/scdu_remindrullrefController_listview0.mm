#import "scdu_remindrullrefController_listview0.h"
@interface scdu_remindrullrefController_listview0_tableViewCell ()
{
	
}
@end
@implementation scdu_remindrullrefController_listview0_tableViewCell
...
-(void)bindAll:(UMEntityContext *)_ctx{
	...
	[self umcontrol:_listview0_childWgt0_label0 controlid:@"listview0_childWgt0_label0" bindfield:@"desc"];
...
@interface scdu_remindrullrefController_listview0_group ()
{
	
}
@end
@implementation scdu_remindrullrefController_listview0_group
...
@interface scdu_remindrullrefController_listview0_cellHeight ()
{
	
}
@end
@implementation scdu_remindrullrefController_listview0_cellHeight
