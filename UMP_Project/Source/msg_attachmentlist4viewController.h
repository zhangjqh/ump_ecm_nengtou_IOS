...
@interface msg_attachmentlist4viewController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	Msg_AttachmentList4View;
- (UMLayoutView*)Msg_AttachmentList4View BV_OBJC_METHOD_FAMILY_NONE;
