...
@implementation ecm_flashController
...
static NSString *controllerC = @"Ecm_FlashController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Ecm_Flash addSubUMView:_basePanel];
     //设置控件基本属性
    ...
    [(UMLayoutView*)_basePanel addSubUMView:_panel0];
     //设置控件基本属性
...
// --logoImg
    _logoImg = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"logoImg",
                          @"height":@"50",
                          @"width":@"76",
                          @"scaletype":@"fitcenter",
                          @"src":@"logo_yonyou.png",@"value":@""}];
    [(UMLayoutView*)_basePanel addSubUMXView:_logoImg];

    _panel1 = [[UMLayoutView alloc] init];
    _panel1.controlId = @"panel1";
    _panel1.layoutType = Layout_vbox;
    [(UMLayoutView*)_basePanel addSubUMView:_panel1];
     //设置控件基本属性
...
// --textbox0
    _textbox0 = [UMControl creatControl:@"UMXTextField" container:self  params:@{
                          ...
                          @"color":@"#E11714",
                          @"font-size":@"12",
                          @"value":@"Power by UAP Mobile",
                          @"font-family":@"default",
                          @"txt_b":@"0.078431375",
                          @"readonly":@"true"}];
    [(UMLayoutView*)_basePanel addSubUMXView:_textbox0];

    _panel2 = [[UMLayoutView alloc] init];
    _panel2.controlId = @"panel2";
    _panel2.layoutType = Layout_vbox;
    [(UMLayoutView*)_basePanel addSubUMView:_panel2];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"loadConfig" method:@"UMService.loadConfigure" sender:sender]];
 ...
 [args putValue:@"beforeLogin" forKey:@"callback"];
...
[args setInvoke:[self getInvokeInfo:@"loginAction" method:@"UMService.login" sender:sender]];
 ...
 [args putValue:@"toLogin" forKey:@"error"];
...
- (void)beforeLogin:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"beforeLogin" method:@"beforeLogin" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
