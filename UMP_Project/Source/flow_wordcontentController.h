...
@interface flow_wordcontentController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	WordContent;
- (UMLayoutView*)WordContent BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMLayoutView* downOutPanel;
- (UMLayoutView*)downOutPanel BV_OBJC_METHOD_FAMILY_NONE;


@property (strong) UMLayoutView* downInnerPanel;
- (UMLayoutView*)downInnerPanel BV_OBJC_METHOD_FAMILY_NONE;
...
@property (nonatomic,strong) UMView* webView;


@property (nonatomic,strong) UMView* downloadLabel;

@property (nonatomic,strong) UMView* downloadBtn;
