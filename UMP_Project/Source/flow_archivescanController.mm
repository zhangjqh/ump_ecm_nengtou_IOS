...
#import "flow_archivescanController.h"
...
@interface flow_archivescanController ()
{
...
@implementation flow_archivescanController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize ArchiveScan = _ArchiveScan;
...
static NSString *controllerC = @"ArchiveScanController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_ArchiveScan addSubUMView:_basePanel];
     //设置控件基本属性
...
// --folderTxt
    _folderTxt = [UMControl creatControl:@"UMXLabel" container:self  params:@{
...
// --switchBtn
    ...
    [(UMLayoutView*)_panel0 addSubUMView:_spaceInnerPanel2];
     //设置控件基本属性
