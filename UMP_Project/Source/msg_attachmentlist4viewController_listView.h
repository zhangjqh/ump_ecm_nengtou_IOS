...
@interface msg_attachmentlist4viewController_listView_tableViewCell:LHTableViewCell
...
@interface msg_attachmentlist4viewController_listView_group : LHGroup
...
@interface msg_attachmentlist4viewController_listView_cellHeight : NSObject
@property (strong) UMLayoutView* itemPanel;
- (UMLayoutView*)itemPanel BV_OBJC_METHOD_FAMILY_NONE;
