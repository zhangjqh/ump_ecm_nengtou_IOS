#import "scdu_repeatdayrefController_listview0.h"
@interface scdu_repeatdayrefController_listview0_tableViewCell ()
{
	
}
@end
@implementation scdu_repeatdayrefController_listview0_tableViewCell
          ...
          case 0:
{
    ...
    [_listview0_childWgt0_panel0 addEvent:@"onclick" actionName:@"setChecked"];
...
@interface scdu_repeatdayrefController_listview0_group ()
{
	
}
@end
@implementation scdu_repeatdayrefController_listview0_group
...
@interface scdu_repeatdayrefController_listview0_cellHeight ()
{
	
}
@end
@implementation scdu_repeatdayrefController_listview0_cellHeight
