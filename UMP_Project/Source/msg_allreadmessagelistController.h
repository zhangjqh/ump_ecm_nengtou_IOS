...
@interface msg_allreadmessagelistController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	msg_AllReadMessageList;
- (UMLayoutView*)msg_AllReadMessageList BV_OBJC_METHOD_FAMILY_NONE;
