...
@interface flow_attachmenteditController ()
{
...
@implementation flow_attachmenteditController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize AttachmentEdit = _AttachmentEdit;
...
static NSString *controllerC = @"AttachmentEditController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_AttachmentEdit addSubUMView:_basePanel];
     //设置控件基本属性
...
[self umcontrol:_listView controlid:@"listView" bindfield:@"attachment"];
...
[args setInvoke:[self getInvokeInfo:@"onDeleteBtnClick" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"attachment" forKey:@"attachname_arrayPath"];

 [args putValue:@"#{cursor.cursorattachmentalias.index}" forKey:@"index"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.id}" forKey:@"attachid"];

 [args putValue:@"cursorattachmentalias" forKey:@"cursor"];

 [args putValue:@"nc.bs.oa.oama.ecm.MaFileController" forKey:@"viewid"];

 [args putValue:@"attachment" forKey:@"index_arrayPath"];

 [args putValue:@"#{#{cursor.cursorattachmentalias}.name}" forKey:@"attachname"];

 [args putValue:@"attachment" forKey:@"attachid_arrayPath"];
