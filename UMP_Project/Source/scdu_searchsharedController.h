...
@interface scdu_searchsharedController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	searchshared;
- (UMLayoutView*)searchshared BV_OBJC_METHOD_FAMILY_NONE;
