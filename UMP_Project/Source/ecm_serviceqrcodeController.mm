...
#import "ecm_serviceqrcodeController.h"
...
@interface ecm_serviceqrcodeController ()
{
...
@implementation ecm_serviceqrcodeController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize Ecm_Serviceqrcode = _Ecm_Serviceqrcode;
...
static NSString *controllerC = @"Ecm_ServiceqrcodeController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _Ecm_Serviceqrcode = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Ecm_Serviceqrcode addSubUMView:_viewPage0];
     //设置控件基本属性
    ...
    _navigatorbar0.naviTitle = [UMParser parseExpr:nil expr:@"地址二维码" ctx:_ctx];;
...
// --urlimage0
    _urlimage0 = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"urlimage0",
                          @"height":@"139",
                          @"width":@"139",
                          @"scaletype":@"fitcenter",
                          @"src":@"#{app.maserver}hroa/img/ECMQR/MAServer.png",
                          @"margin-top":@"120",@"value":@""}];
    [(UMLayoutView*)_panel0 addSubUMXView:_urlimage0];
...
- (void)closeqrcode:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"closeqrcode" method:@"UMView.close" sender:sender]];
