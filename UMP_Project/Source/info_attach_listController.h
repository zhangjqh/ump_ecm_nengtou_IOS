...
@interface info_attach_listController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	attach_list;
- (UMLayoutView*)attach_list BV_OBJC_METHOD_FAMILY_NONE;
