...
@interface info_commentdetailController ()
{
...
@implementation info_commentdetailController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize Info_commentdetail = _Info_commentdetail;
...
static NSString *controllerC = @"Info_commentdetailController";
...
- (id)initWithParentCtl:(UIViewController*)parentCtl
{
    ...
    if (self) {
        ...
        _Info_commentdetail = _viewObject;
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_Info_commentdetail addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.info_title_commentdetail}"}];
...
// --commentperson
    _commentperson = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"width":@"fill",
                          @"txt_r":@"0.0",
                          @"font_size":@"16",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_panel0 addSubUMXView:_commentperson];

// --commentdate
    _commentdate = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"width":@"fill",
                          @"txt_r":@"0.0",
                          @"font_size":@"12",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@""}];
    [(UMLayoutView*)_panel0 addSubUMXView:_commentdate];

// --commentcontent
    _commentcontent = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"width":@"fill",
                          @"font_size":@"14",
                          @"txt_r":@"0.0",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"top",@"value":@""}];
    [(UMLayoutView*)_panel1 addSubUMXView:_commentcontent];
...
[args setInvoke:[self getInvokeInfo:@"returnList" method:@"UMView.close" sender:sender]];

 [args putValue:@"0" forKey:@"resultcode"];
[UMCommonSevice callSeviceWithMethod:args];

}
- (void)dataload:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"dataload" method:@"dataload" sender:sender]];
[UMCommonSevice callSeviceWithMethod:args];
