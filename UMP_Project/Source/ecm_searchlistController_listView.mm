#import "ecm_searchlistController_listView.h"
@interface ecm_searchlistController_listView_tableViewCell ()
{
	
}
@end
@implementation ecm_searchlistController_listView_tableViewCell
...
case 2:
{
    _listView_childWgt2 = [[UMLayoutView alloc] init];
    _listView_childWgt2.controlId = @"listView_childWgt2";
    _listView_childWgt2.layoutType = Layout_hbox;
     //设置控件基本属性
    [UMCompatible initCommonProperty:_listView_childWgt2 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"15",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"15",@"paddingRightUMP",
    ...
    [_listView_childWgt2 setContainer:self];
    [_listView_childWgt2 addEvent:@"onclick" actionName:@"onItemClick"];

// --listView_childWgt2_orgName
    _listView_childWgt2_orgName = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"bindfield":@"name",
                          @"halign":@"left",
                          @"weight":@"1",
                          @"width":@"0",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"OrgName"}];
    [(UMLayoutView*)_listView_childWgt2 addSubUMXView:_listView_childWgt2_orgName];

// --listView_childWgt2_orgNum
    _listView_childWgt2_orgNum = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"bindfield":@"num",
                          @"halign":@"right",
                          @"width":@"50",
                          @"font_size":@"14",
                          @"txt_r":@"0.5568628",
                          @"id":@"listView_childWgt2_orgNum",
                          @"txt_g":@"0.5568628",
                          @"height":@"fill",
                          @"font_family":@"ArialMT",
                          @"color":@"#8e8e93",
    ...
    [(UMLayoutView*)_listView_childWgt2 addSubUMXView:_listView_childWgt2_orgNum];

// --listView_childWgt2_orgSpace
    _listView_childWgt2_orgSpace = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"center",
                          @"width":@"15",
                          @"font_size":@"14",
                          @"txt_r":@"0.0",
                          @"id":@"listView_childWgt2_orgSpace",
                          @"txt_g":@"0.0",
                          @"height":@"fill",
                          @"color":@"#000000",
                          @"font_family":@"ArialMT",
                          ...
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@""}];
    [(UMLayoutView*)_listView_childWgt2 addSubUMXView:_listView_childWgt2_orgSpace];

// --listView_childWgt2_orgImg
    _listView_childWgt2_orgImg = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"listView_childWgt2_orgImg",
                          @"height":@"13",
                          @"width":@"8",
                          @"scaletype":@"fitcenter",
                          @"src":@"oa_ecm_right.png",@"value":@""}];
    [(UMLayoutView*)_listView_childWgt2 addSubUMXView:_listView_childWgt2_orgImg];

[self.contentView addSubview:_listView_childWgt2.content];
self.cellHeight = @"44";
break;
}
case 3:
{
    _listView_childWgt3 = [[UMLayoutView alloc] init];
    _listView_childWgt3.controlId = @"listView_childWgt3";
    _listView_childWgt3.layoutType = Layout_hbox;
     //设置控件基本属性
    [UMCompatible initCommonProperty:_listView_childWgt3 info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"15",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"15",@"paddingRightUMP",
    ...
    [_listView_childWgt3 setContainer:self];
    [_listView_childWgt3 addEvent:@"onclick" actionName:@"onItemClick"];

// --listView_childWgt3_empLabel
    _listView_childWgt3_empLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"weight":@"1",
                          @"width":@"0",
                          @"font_size":@"16",
                          @"txt_r":@"0.0",
                          @"id":@"listView_childWgt3_empLabel",
                          @"txt_g":@"0.0",
                          @"height":@"fill",
                          @"font_family":@"ArialMT",
                          @"color":@"#000000",
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"员工"}];
    [(UMLayoutView*)_listView_childWgt3 addSubUMXView:_listView_childWgt3_empLabel];

// --listView_childWgt3_empNum
    _listView_childWgt3_empNum = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"bindfield":@"num",
                          @"halign":@"right",
                          @"width":@"50",
                          @"font_size":@"14",
                          @"txt_r":@"0.5568628",
                          @"id":@"listView_childWgt3_empNum",
                          @"txt_g":@"0.5568628",
                          @"height":@"fill",
                          @"font_family":@"ArialMT",
                          @"color":@"#8e8e93",
                          ...
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"Num"}];
    [(UMLayoutView*)_listView_childWgt3 addSubUMXView:_listView_childWgt3_empNum];

// --listView_childWgt3_empSpace
    _listView_childWgt3_empSpace = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"center",
                          @"width":@"15",
                          @"font_size":@"14",
                          @"txt_r":@"0.0",
                          @"id":@"listView_childWgt3_empSpace",
                          @"txt_g":@"0.0",
                          @"height":@"fill",
                          @"color":@"#000000",
                          @"font_family":@"ArialMT",
                          ...
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@""}];
    [(UMLayoutView*)_listView_childWgt3 addSubUMXView:_listView_childWgt3_empSpace];

// --listView_childWgt3_empImg
    _listView_childWgt3_empImg = [UMControl creatControl:@"UMXXImageView" container:self  params:@{
                          @"id":@"listView_childWgt3_empImg",
                          @"height":@"13",
                          @"width":@"8",
                          @"scaletype":@"fitcenter",
                          @"src":@"oa_ecm_right.png",@"value":@""}];
    [(UMLayoutView*)_listView_childWgt3 addSubUMXView:_listView_childWgt3_empImg];

[self.contentView addSubview:_listView_childWgt3.content];
self.cellHeight = @"44";
break;
}
...
[self umcontrol:_listView_childWgt2_orgName controlid:@"listView_childWgt2_orgName" bindfield:@"name"];
[self umcontrol:_listView_childWgt2_orgNum controlid:@"listView_childWgt2_orgNum" bindfield:@"num"];
[self umcontrol:_listView_childWgt3_empNum controlid:@"listView_childWgt3_empNum" bindfield:@"num"];
...
case 2:
{
[self setWgtFrame:_listView_childWgt2];
[self bindAll:_ctx];
[_listView_childWgt2 adjustSizeForParentest:self];
break;
}
case 3:
{
[self setWgtFrame:_listView_childWgt3];
[self bindAll:_ctx];
[_listView_childWgt3 adjustSizeForParentest:self];
break;
}
...
@interface ecm_searchlistController_listView_group ()
{
	
}
@end
@implementation ecm_searchlistController_listView_group
...
@interface ecm_searchlistController_listView_cellHeight ()
{
	
}
@end
@implementation ecm_searchlistController_listView_cellHeight
