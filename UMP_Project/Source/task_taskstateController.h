...
@interface task_taskstateController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	taskstateref;
- (UMLayoutView*)taskstateref BV_OBJC_METHOD_FAMILY_NONE;
