...
@interface info_infosController ()
{
...
@implementation info_infosController
...
static NSString *controllerC = @"infosController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_infos addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"default",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.info_title_new}"}];
    ...
    [(UMLayoutView*)_navigatorbar0 addSubUMView:_panel2];
     //设置控件基本属性
...
- (void)infoNextPage:(id<UMViewControl>)sender args:(XEventArgs *)args{
if(args==nil) {
  args = [[XEventArgs alloc] init:self];
}
[args setInvoke:[self getInvokeInfo:@"infoNextPage" method:@"UMList.getNextPage" sender:sender]];

 [args putValue:@"nc.bs.oa.oainf.ma.infopublish.OainflistExtendController" forKey:@"viewid"];

 [args putValue:@"InfoLoadNextPage" forKey:@"action"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"loginAction" method:@"UMService.login" sender:sender]];
 ...
 [args putValue:@"nextImgLoad" forKey:@"success"];
[UMCommonSevice callSeviceWithMethod:args];
...
[args setInvoke:[self getInvokeInfo:@"nextImgLoad" method:@"UMList.getFirstPage" sender:sender]];
 ...
 [args putValue:@"InfoLoadFirstPage" forKey:@"action"];
[UMCommonSevice callSeviceWithMethod:args];
