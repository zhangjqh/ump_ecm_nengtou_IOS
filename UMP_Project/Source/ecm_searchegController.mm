...
@interface ecm_searchegController ()
{
...
static NSString *controllerC = @"EcmSearchEGController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_SearchEG addSubUMView:_basePanel];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"loadData" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"entGroup" forKey:@"action"];
