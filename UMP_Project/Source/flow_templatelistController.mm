...
#import "flow_templatelistController.h"
...
@interface flow_templatelistController ()
{
...
@implementation flow_templatelistController
...
@synthesize rangePanel = _rangePanel;
...
static NSString *controllerC = @"TemplateListController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"TemplateList";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_TemplateList addSubUMView:_basePanel];
     //设置控件基本属性
...
// --navLabel
    _navLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"txt_b":@"0.0",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_templatelist}"}];
    ...
    _rangePanel = [[UMLayoutView alloc] init];
    _rangePanel.controlId = @"rangePanel";
    _rangePanel.layoutType = Layout_hbox;
    [(UMLayoutView*)_mainPanel addSubUMView:_rangePanel];
     //设置控件基本属性
    [UMCompatible initCommonProperty:_rangePanel info:[NSDictionary dictionaryWithObjectsAndKeys:
                          @"0",@"weightUMPView",
                          @"15",@"paddingLeftUMP",
                          @"0",@"paddingTopUMP",
                          @"15",@"paddingRightUMP",
...
// --rangeLabel
    _rangeLabel = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          @"halign":@"left",
                          @"width":@"fill",
                          @"font_size":@"14",
                          @"txt_r":@"0.5568628",
                          ...
                          @"txt_b":@"0.5764706",
                          @"valign":@"center",
                          @"readonly":@"true",@"value":@"#{res.flow_outofrange}"}];
    [(UMLayoutView*)_rangePanel addSubUMXView:_rangeLabel];
...
[self umcontrol:_listView controlid:@"listView" bindfield:@"templates"];
...
[args setInvoke:[self getInvokeInfo:@"onDataLoad" method:@"UMService.callAction" sender:sender]];

 [args putValue:@"nc.bs.oa.oama.freeflow.TemplateController" forKey:@"viewid"];
...
[args setInvoke:[self getInvokeInfo:@"onItemClick" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"cursortemplatesalias" forKey:@"cursor"];

 [args putValue:@"nc.bs.oa.oama.freeflow.TemplateController" forKey:@"viewid"];

 [args putValue:@"templates" forKey:@"templateid_arrayPath"];

 [args putValue:@"gotoEdit" forKey:@"callback"];

 [args putValue:@"detail" forKey:@"action"];

 [args putValue:@"#{#{cursor.cursortemplatesalias}.id}" forKey:@"templateid"];

 [args putValue:@"false" forKey:@"autodatabinding"];

 [args putValue:@"CurrentWork" forKey:@"contextmapping"];
  [UMCompatible exec:sender container:self cursor:@"cursortemplatesalias"];
[UMCommonSevice callSeviceWithMethod:args];
