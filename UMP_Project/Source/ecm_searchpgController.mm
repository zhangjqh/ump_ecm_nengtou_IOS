...
#import "ecm_searchpgController.h"
...
@interface ecm_searchpgController ()
{
...
static NSString *controllerC = @"EcmSearchPGController";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_SearchPG addSubUMView:_basePanel];
     //设置控件基本属性
...
[args setInvoke:[self getInvokeInfo:@"loadData" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"psnGroup" forKey:@"action"];
