...
@interface scdu_onerepeatdayrefController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	onerepeatdayref;
- (UMLayoutView*)onerepeatdayref BV_OBJC_METHOD_FAMILY_NONE;
