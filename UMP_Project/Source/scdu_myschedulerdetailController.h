...
@interface scdu_myschedulerdetailController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	myschedulerdetail;
- (UMLayoutView*)myschedulerdetail BV_OBJC_METHOD_FAMILY_NONE;
