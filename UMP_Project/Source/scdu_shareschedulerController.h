...
@interface scdu_shareschedulerController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	sharescheduler;
- (UMLayoutView*)sharescheduler BV_OBJC_METHOD_FAMILY_NONE;
...
@property (strong) UMCalendarView* calendar0;
- (UMGirdView*)calendar0 BV_OBJC_METHOD_FAMILY_NONE;
