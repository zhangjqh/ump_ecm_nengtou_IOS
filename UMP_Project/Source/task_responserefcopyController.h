...
@interface task_responserefcopyController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	responserefcopywin;
- (UMLayoutView*)responserefcopywin BV_OBJC_METHOD_FAMILY_NONE;
