...
@interface flow_attachmenteditController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	AttachmentEdit;
- (UMLayoutView*)AttachmentEdit BV_OBJC_METHOD_FAMILY_NONE;
