...
#import "scdu_remindrullrefController.h"
...
@interface scdu_remindrullrefController ()
{
...
@implementation scdu_remindrullrefController
@synthesize navBarHidden = _navBarHidden;
@synthesize viewObject = _viewObject;
@synthesize remindrullref = _remindrullref;
...
static NSString *controllerC = @"remindrullrefController";

static NSString *namespaceC = @"nc.bs.oa.oama.ecm";

static NSString *ModelName = @"alertRuleList";
...
- (void)initChilds
{
    ...
    [(UMLayoutView*)_remindrullref addSubUMView:_viewPage0];
     //设置控件基本属性
...
// --label0
    _label0 = [UMControl creatControl:@"UMXLabel" container:self  params:@{
                          ...
                          @"font-family":@"Serif",
                          @"txt_b":@"0.0",
                          @"valign":@"center",@"value":@"#{res.scdu_oascheduler_0037}"}];
...
[self umcontrol:_listview0 controlid:@"listview0" bindfield:@"alertRules"];
...
[args setInvoke:[self getInvokeInfo:@"onClickListRow" method:@"UMView.close" sender:sender]];
 ...
 [args putValue:@"alertRules" forKey:@"result_arrayPath"];
...
[args setInvoke:[self getInvokeInfo:@"load" method:@"UMService.callAction" sender:sender]];
 ...
 [args putValue:@"getAlertRuleList" forKey:@"action"];

 [args putValue:@"#{plug.isalldayswitch}" forKey:@"isalldayswitch"];
