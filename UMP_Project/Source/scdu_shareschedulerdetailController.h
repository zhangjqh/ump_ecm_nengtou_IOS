...
@interface scdu_shareschedulerdetailController:UMBaseViewController
...
@property (nonatomic,strong) UMLayoutView*	shareschedulerdetail;
- (UMLayoutView*)shareschedulerdetail BV_OBJC_METHOD_FAMILY_NONE;
