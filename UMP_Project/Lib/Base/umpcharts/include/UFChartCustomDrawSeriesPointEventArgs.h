//
//  UFChartCustomDrawSeriesPointEventArgs.h
//  UFCharts
//
...
/**
 *	@brief	提供 UFChartSeriesPoint 绘制自定义属性。
 */
@interface UFChartCustomDrawSeriesPointEventArgs : NSObject {

    __unsafe_unretained UFChartSeries *_series;
    __unsafe_unretained UFChartSeriesPoint *_seriesPoint;
...
/**
 *	@brief	获取要绘制的 UFChartSeriesPoint 所在 UFChartSeries 。
 */
@property(readonly, unsafe_unretained) UFChartSeries *series;

/**
 *	@brief	获取要绘制的 UFChartSeriesPoint 。
 */
@property(readonly, unsafe_unretained) UFChartSeriesPoint *seriesPoint;
...
- (id)initWith:(UFChartSeries *)series
      seriesPoint:(UFChartSeriesPoint *)seriesPoint
seriesDrawOptions:(UFChartDrawOptions *)drawOptions
legendDrawOptions:(UFChartDrawOptions *)legendDrawOptions
legendTextVisible:(BOOL)legendTextVisible legendText:(NSString *)legendText
  legendTextColor:(UFSfxDrawColor *)legendTextColor font:(UFSfxDrawFont *)font
legendMarkerImage:(UIImage *)legendMarkerImage
   legendMarkerSize:(UFSfxSizeF *)legendMarkerSize
legendMarkerVisible:(BOOL)legendMarkerVisible;
